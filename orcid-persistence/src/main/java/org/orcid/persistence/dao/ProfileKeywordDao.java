...
public interface ProfileKeywordDao extends GenericDao<ProfileKeywordEntity, Long> {
    ...
    List<ProfileKeywordEntity> getProfileKeywors(String orcid, org.orcid.jaxb.model.common_rc3.Visibility visibility);
     ...
     * */
    boolean addProfileKeyword(String orcid, String keyword, String sourceId, String clientSourceId, org.orcid.jaxb.model.common_rc3.Visibility visibility);
