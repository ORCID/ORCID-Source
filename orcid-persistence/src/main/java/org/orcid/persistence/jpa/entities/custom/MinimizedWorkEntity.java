...
/**
 * An object that will contain the minimum work information needed to display work in the UI.
 * 
...
public class MinimizedWorkEntity {
	...
	public MinimizedWorkEntity(Long id, String title, String subtitle,
			String description, int publicationDay, int publicationMonth,
			int publicationYear, Visibility visibility) {
		super();
		this.id = id;
		this.title = title;
