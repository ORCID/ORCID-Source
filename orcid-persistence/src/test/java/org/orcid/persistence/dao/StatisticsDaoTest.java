...
public class StatisticsDaoTest extends DBUnitTest {
    ...
    public void testStatistics(){
        long s1 = statisticsGeneratorDao.getAccountsWithVerifiedEmails(); //It is 1
        long s2 = statisticsGeneratorDao.getAccountsWithWorks(); //It is 1
        long s3 = statisticsGeneratorDao.getLiveIds(); //It is 6
        long s4 = statisticsGeneratorDao.getNumberOfWorks(); //It is 2
        long s5 = statisticsGeneratorDao.getNumberOfWorksWithDOIs(); //It is 0
