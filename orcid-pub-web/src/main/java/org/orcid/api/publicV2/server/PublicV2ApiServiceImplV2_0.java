...
public class PublicV2ApiServiceImplV2_0 {
    ...
    @Produces(value = { VND_ORCID_XML, ORCID_XML, MediaType.APPLICATION_XML, VND_ORCID_JSON, ORCID_JSON, MediaType.APPLICATION_JSON })
    @Path(WORKS)
    //@Operation(description = "Fetch all works", response = Works.class)
    ...
    @Produces(value = { VND_ORCID_XML, ORCID_XML, MediaType.APPLICATION_XML, VND_ORCID_JSON, ORCID_JSON, MediaType.APPLICATION_JSON })
    @Path(BULK_WORKS)
    //@Operation(description = "Fetch specified works", response = WorkBulk.class)
    ...
    @Produces(value = { VND_ORCID_XML, ORCID_XML, MediaType.APPLICATION_XML, VND_ORCID_JSON, ORCID_JSON, MediaType.APPLICATION_JSON })
    @Path(FUNDINGS)
    //@Operation(description = "Fetch all fundings", response = Fundings.class)    
    ...
    @Produces(value = { VND_ORCID_XML, ORCID_XML, MediaType.APPLICATION_XML, VND_ORCID_JSON, ORCID_JSON, MediaType.APPLICATION_JSON })
    @Path(EDUCATIONS)
    //@Operation(description = "Fetch all educations", response = Educations.class)    
    ...
    @Produces(value = { VND_ORCID_XML, ORCID_XML, MediaType.APPLICATION_XML, VND_ORCID_JSON, ORCID_JSON, MediaType.APPLICATION_JSON })
    @Path(EMPLOYMENTS)
    //@Operation(description = "Fetch all employments", response = Employments.class)    
    ...
    @Produces(value = { VND_ORCID_XML, ORCID_XML, MediaType.APPLICATION_XML, VND_ORCID_JSON, ORCID_JSON, MediaType.APPLICATION_JSON })
    @Path(PEER_REVIEWS)
    //@Operation(description = "Fetch all peer reviews", response = PeerReviews.class)    
    ...
    //@Operation(description = "Fetch all researcher urls for an ORCID ID", response = ResearcherUrls.class)
    ...
    //@Operation(description = "Fetch one researcher url for an ORCID ID", response = ResearcherUrls.class)
    ...
    @Produces(value = { VND_ORCID_XML, ORCID_XML, MediaType.APPLICATION_XML, VND_ORCID_JSON, ORCID_JSON, MediaType.APPLICATION_JSON })
    @Path(EMAIL)
    //@Operation(description = "Fetch all emails for an ORCID ID",response = Emails.class)
    ...
    //@Operation(description = "Fetch personal details for an ORCID ID", response = PersonalDetails.class)
    ...
    @Produces(value = { VND_ORCID_XML, ORCID_XML, MediaType.APPLICATION_XML, VND_ORCID_JSON, ORCID_JSON, MediaType.APPLICATION_JSON })
    @Path(OTHER_NAMES)
    //@Operation(description = "Fetch Other names", response = OtherNames.class)
    ...
    //@Operation(description = "Fetch Other name", response = OtherName.class)
    ...
    /*@Operation(description = "Fetch external identifiers", response = PersonExternalIdentifiers.class, authorizations = {
    ...
    //@Operation(description = "Fetch external identifier", response = PersonExternalIdentifier.class)
    ...
    @Produces(value = { VND_ORCID_XML, ORCID_XML, MediaType.APPLICATION_XML, VND_ORCID_JSON, ORCID_JSON, MediaType.APPLICATION_JSON })
    @Path(KEYWORDS)
    //@Operation(description = "Fetch keywords", response = Keywords.class)
    ...
    //@Operation(description = "Fetch keyword", response = Keyword.class)
    ...
    @Produces(value = { VND_ORCID_XML, ORCID_XML, MediaType.APPLICATION_XML, VND_ORCID_JSON, ORCID_JSON, MediaType.APPLICATION_JSON })
    @Path(ADDRESS)
    //@Operation(description = "Fetch all addresses", response = Addresses.class)
    ...
    //@Operation(description = "Fetch an address",response = Address.class)
    ...
    @Produces(value = { VND_ORCID_XML, ORCID_XML, MediaType.APPLICATION_XML, VND_ORCID_JSON, ORCID_JSON, MediaType.APPLICATION_JSON })
    @Path(BIOGRAPHY)
    //@Operation(description = "Get biography details", response = Biography.class)
    ...
    @Produces(value = { VND_ORCID_XML, ORCID_XML, MediaType.APPLICATION_XML, VND_ORCID_JSON, ORCID_JSON, MediaType.APPLICATION_JSON })
    @Path(PERSON)
    //@Operation(description = "Fetch person details", response = Person.class)
    ...
    //@Operation(description = "Fetch record details", response = Record.class)
    ...
    @Produces(value = { VND_ORCID_XML, ORCID_XML, MediaType.APPLICATION_XML, VND_ORCID_JSON, ORCID_JSON, MediaType.APPLICATION_JSON })
    @Path(SEARCH_PATH)
    //@Operation(description = "Search records", response = Search.class)
    ...
    @Path(CLIENT_PATH)
    @Produces(value = { VND_ORCID_XML, ORCID_XML, MediaType.APPLICATION_XML, VND_ORCID_JSON, ORCID_JSON, MediaType.APPLICATION_JSON })
    //@Operation(description = "Fetch client details", response = ClientSummary.class)
