...
public class T1OrcidApiServiceImplLatestMetricsTest {
    ...
    @Resource
    private T1OrcidApiServiceImplLatest t1OrcidApiService;
    ...
    public void resetVals() {
        T1OrcidApiServiceImplLatest.T1_SEARCH_REQUESTS.clear();
        T1OrcidApiServiceImplLatest.T1_GET_REQUESTS.clear();
        T1OrcidApiServiceImplLatest.T1_SEARCH_RESULTS_NONE_FOUND.clear();
        T1OrcidApiServiceImplLatest.T1_SEARCH_RESULTS_FOUND.clear();
    }

    @Test
    public void testCounterUnaffectedByViewStatus() {
        assertTrue(T1OrcidApiServiceImplLatest.T1_SEARCH_REQUESTS.count() == 0);
        assertTrue(T1OrcidApiServiceImplLatest.T1_GET_REQUESTS.count() == 0);
    ...
    public void testViewBioDetailsHtml() {
        ...
        assertEquals(200, response.getStatus());
        assertTrue(T1OrcidApiServiceImplLatest.T1_GET_REQUESTS.count() == 1);
        assertTrue(T1OrcidApiServiceImplLatest.T1_SEARCH_REQUESTS.count() == 0);
    }
    ...
    public void testSearchByQueryJSON() {
        ...
        assertTrue(T1OrcidApiServiceImplLatest.T1_SEARCH_REQUESTS.count() == 0);
        assertTrue(T1OrcidApiServiceImplLatest.T1_GET_REQUESTS.count() == 0);
        assertTrue(T1OrcidApiServiceImplLatest.T1_SEARCH_RESULTS_FOUND.count() == 0);
        assertTrue(T1OrcidApiServiceImplLatest.T1_SEARCH_RESULTS_NONE_FOUND.count() == 0);
        ...
        assertEquals(200, response.getStatus());
        assertTrue(T1OrcidApiServiceImplLatest.T1_GET_REQUESTS.count() == 0);
        assertTrue(T1OrcidApiServiceImplLatest.T1_SEARCH_REQUESTS.count() == 1);
        assertTrue(T1OrcidApiServiceImplLatest.T1_SEARCH_RESULTS_NONE_FOUND.count() == 1);
        assertTrue(T1OrcidApiServiceImplLatest.T1_SEARCH_RESULTS_FOUND.count() == 0);
    }
    ...
    public void testSearchByQueryXMLResultsReturned() {
        ...
        assertTrue(T1OrcidApiServiceImplLatest.T1_SEARCH_REQUESTS.count() == 1);
        assertTrue(T1OrcidApiServiceImplLatest.T1_SEARCH_RESULTS_NONE_FOUND.count() == 0);
        assertTrue(T1OrcidApiServiceImplLatest.T1_SEARCH_RESULTS_FOUND.count() == 3);
    }
