...
65. Visit https://qa.orcid.org/signout
...
66. Go to the CI server (https://ci.orcid.org/) and select ORCID-independent-tests-step2

67. Build the ORCID Independent Tests 2 with the following parameters
