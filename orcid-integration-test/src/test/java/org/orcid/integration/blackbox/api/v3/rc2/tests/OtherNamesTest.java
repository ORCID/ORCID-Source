...
public class OtherNamesTest extends BlackBoxBaseV3_0_rc2 {
    ...
    private static org.orcid.jaxb.model.v3.rc2.common.Visibility currentOtherNamesVisibility = null;
    ...
    private static void changeCurrentOtherNamesVisibility(org.orcid.jaxb.model.v3.rc2.common.Visibility v) {
    ...
    public void testCreateGetUpdateAndDeleteOtherName() throws InterruptedException, JSONException {
        ...
        changeCurrentOtherNamesVisibility(org.orcid.jaxb.model.v3.rc2.common.Visibility.PUBLIC); 

        String accessToken = getAccessToken();
        assertNotNull(accessToken);
        org.orcid.jaxb.model.v3.rc2.record.OtherName newOtherName = new org.orcid.jaxb.model.v3.rc2.record.OtherName();
        newOtherName.setContent("other-name-3" + System.currentTimeMillis());
        newOtherName.setVisibility(org.orcid.jaxb.model.v3.rc2.common.Visibility.LIMITED);

        // Create
        ClientResponse response = memberV3Rc2ApiClient.createOtherName(getUser1OrcidId(), newOtherName, accessToken);
        ...
        // Get and verify
        response = memberV3Rc2ApiClient.viewOtherNames(getUser1OrcidId(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), response.getStatus());
        org.orcid.jaxb.model.v3.rc2.record.OtherNames otherNames = response.getEntity(org.orcid.jaxb.model.v3.rc2.record.OtherNames.class);
        ...
        for (org.orcid.jaxb.model.v3.rc2.record.OtherName existingOtherName : otherNames.getOtherNames()) {
            if (otherName1.equals(existingOtherName.getContent())) {
                assertEquals(org.orcid.jaxb.model.v3.rc2.common.Visibility.PUBLIC, existingOtherName.getVisibility());
                found1 = true;
                ...
                assertEquals(org.orcid.jaxb.model.v3.rc2.common.Visibility.LIMITED, existingOtherName.getVisibility());
                foundNew = true;
            }
        }
        ...
        // Get it
        response = memberV3Rc2ApiClient.viewOtherName(this.getUser1OrcidId(), putCode, accessToken);
        assertNotNull(response);
        org.orcid.jaxb.model.v3.rc2.record.OtherName otherName = response.getEntity(org.orcid.jaxb.model.v3.rc2.record.OtherName.class);
        ...
        org.orcid.jaxb.model.v3.rc2.common.Visibility originalVisibility = otherName.getVisibility();
        ...
        ClientResponse putResponse = memberV3Rc2ApiClient.updateOtherName(this.getUser1OrcidId(), otherName, accessToken);
        ...
        response = memberV3Rc2ApiClient.updateOtherName(this.getUser1OrcidId(), otherName, accessToken);
        assertNotNull(response);
        assertEquals(ClientResponse.Status.OK.getStatusCode(), response.getStatus());
        response = memberV3Rc2ApiClient.viewOtherName(this.getUser1OrcidId(), putCode, accessToken);
        assertNotNull(response);
        otherName = response.getEntity(org.orcid.jaxb.model.v3.rc2.record.OtherName.class);
        assertNotNull(otherName);
        ...
        // Delete
        response = memberV3Rc2ApiClient.deleteOtherName(this.getUser1OrcidId(), putCode, accessToken);
        assertNotNull(response);
    ...
    public void testInvalidPutCodeReturns404() throws InterruptedException, JSONException {
        ...
        org.orcid.jaxb.model.v3.rc2.record.OtherName otherName = new org.orcid.jaxb.model.v3.rc2.record.OtherName();
        otherName.setContent("Other Name #1 " + System.currentTimeMillis());
        otherName.setVisibility(org.orcid.jaxb.model.v3.rc2.common.Visibility.LIMITED);
        otherName.setPutCode(1234567890L);

        ClientResponse response = memberV3Rc2ApiClient.updateOtherName(getUser1OrcidId(), otherName, accessToken);
        assertNotNull(response);
    ...
    public void testGetOtherNamesWithPublicAPI() throws InterruptedException, JSONException {
        ...
        for (org.orcid.jaxb.model.v3.rc2.record.OtherName otherName : otherNames.getOtherNames()) {
    ...
    public void testGetOtherNamesWithMembersAPI() throws InterruptedException, JSONException {
        changeCurrentOtherNamesVisibility(org.orcid.jaxb.model.v3.rc2.common.Visibility.LIMITED);
                
        String accessToken = getAccessToken();
        assertNotNull(accessToken);
        
        ClientResponse getResponse = memberV3Rc2ApiClient.viewOtherNames(getUser1OrcidId(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getResponse.getStatus());
        org.orcid.jaxb.model.v3.rc2.record.OtherNames otherNames = getResponse.getEntity(org.orcid.jaxb.model.v3.rc2.record.OtherNames.class);
        assertNotNull(otherNames);
        assertNotNull(otherNames.getOtherNames());
