 ...
 * =============================================================================
 */
package org.orcid.integration.blackbox.api.v2_1.release.tests;
...
public class WorksTest extends BlackBoxBaseV2_1Release {
    ...
    public void createViewUpdateAndDeleteWork() throws JSONException, InterruptedException, URISyntaxException {
        ...
        ClientResponse putResponse = memberV2_1ApiClient.updateLocationXml(postResponse.getLocation(), accessToken, gotWork);
        ...
        putResponse = memberV2_1ApiClient.updateLocationXml(postResponse.getLocation(), accessToken, gotWork);
