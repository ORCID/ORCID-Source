...
public class OtherNamesTest extends BlackBoxBaseV3_0 {
    ...
    private static org.orcid.jaxb.model.v3.release.common.Visibility currentOtherNamesVisibility = null;
    ...
    public static void setup() {
        ...
        changeOtherNamesVisibility(org.orcid.jaxb.model.v3.release.common.Visibility.PUBLIC.name());
        saveOtherNamesModal();
    }    
    ...
    private static void changeCurrentOtherNamesVisibility(org.orcid.jaxb.model.v3.release.common.Visibility v) {
    ...
    public void testCreateGetUpdateAndDeleteOtherName() throws InterruptedException, JSONException {
        ...
        changeCurrentOtherNamesVisibility(org.orcid.jaxb.model.v3.release.common.Visibility.PUBLIC); 

        String accessToken = getAccessToken();
        assertNotNull(accessToken);
        org.orcid.jaxb.model.v3.release.record.OtherName newOtherName = new org.orcid.jaxb.model.v3.release.record.OtherName();
        newOtherName.setContent("other-name-3" + System.currentTimeMillis());
        newOtherName.setVisibility(org.orcid.jaxb.model.v3.release.common.Visibility.LIMITED);

        // Create
        ClientResponse response = memberV3ApiClient.createOtherName(getUser1OrcidId(), newOtherName, accessToken);
        ...
        // Get and verify
        response = memberV3ApiClient.viewOtherNames(getUser1OrcidId(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), response.getStatus());
        org.orcid.jaxb.model.v3.release.record.OtherNames otherNames = response.getEntity(org.orcid.jaxb.model.v3.release.record.OtherNames.class);
        ...
        for (org.orcid.jaxb.model.v3.release.record.OtherName existingOtherName : otherNames.getOtherNames()) {
            if (otherName1.equals(existingOtherName.getContent())) {
                assertEquals(org.orcid.jaxb.model.v3.release.common.Visibility.PUBLIC, existingOtherName.getVisibility());
                found1 = true;
                ...
                assertEquals(org.orcid.jaxb.model.v3.release.common.Visibility.LIMITED, existingOtherName.getVisibility());
                foundNew = true;
            }
        }
        ...
        // Get it
        response = memberV3ApiClient.viewOtherName(this.getUser1OrcidId(), putCode, accessToken);
        assertNotNull(response);
        org.orcid.jaxb.model.v3.release.record.OtherName otherName = response.getEntity(org.orcid.jaxb.model.v3.release.record.OtherName.class);
        assertNotNull(otherName);
        assertEquals(newOtherName.getContent(), otherName.getContent());
        assertEquals(org.orcid.jaxb.model.v3.release.common.Visibility.LIMITED, otherName.getVisibility());
        ...
        org.orcid.jaxb.model.v3.release.common.Visibility originalVisibility = otherName.getVisibility();
        ...
        ClientResponse putResponse = memberV3ApiClient.updateOtherName(this.getUser1OrcidId(), otherName, accessToken);
        ...
        response = memberV3ApiClient.updateOtherName(this.getUser1OrcidId(), otherName, accessToken);
        assertNotNull(response);
        assertEquals(ClientResponse.Status.OK.getStatusCode(), response.getStatus());
        response = memberV3ApiClient.viewOtherName(this.getUser1OrcidId(), putCode, accessToken);
        assertNotNull(response);
        otherName = response.getEntity(org.orcid.jaxb.model.v3.release.record.OtherName.class);
        assertNotNull(otherName);
        ...
        // Delete
        response = memberV3ApiClient.deleteOtherName(this.getUser1OrcidId(), putCode, accessToken);
        assertNotNull(response);
    ...
    public void testInvalidPutCodeReturns404() throws InterruptedException, JSONException {
        ...
        otherName.setVisibility(org.orcid.jaxb.model.v3.release.common.Visibility.LIMITED);
        otherName.setPutCode(1234567890L);

        ClientResponse response = memberV3ApiClient.updateOtherName(getUser1OrcidId(), otherName, accessToken);
        assertNotNull(response);
    ...
    public void testGetOtherNamesWithPublicAPI() throws InterruptedException, JSONException {
        ...
        for (org.orcid.jaxb.model.v3.release.record.OtherName otherName : otherNames.getOtherNames()) {
            assertEquals(org.orcid.jaxb.model.v3.release.common.Visibility.PUBLIC, otherName.getVisibility());
    ...
    public void testGetOtherNamesWithMembersAPI() throws InterruptedException, JSONException {
        changeCurrentOtherNamesVisibility(org.orcid.jaxb.model.v3.release.common.Visibility.LIMITED);
                
        String accessToken = getAccessToken();
        assertNotNull(accessToken);
        
        ClientResponse getResponse = memberV3ApiClient.viewOtherNames(getUser1OrcidId(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getResponse.getStatus());
        org.orcid.jaxb.model.v3.release.record.OtherNames otherNames = getResponse.getEntity(org.orcid.jaxb.model.v3.release.record.OtherNames.class);
        assertNotNull(otherNames);
        assertNotNull(otherNames.getOtherNames());
