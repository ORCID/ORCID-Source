...
public class OtherNamesTest extends BlackBoxBaseV2Release {
    ...
    @SuppressWarnings({ "rawtypes", "deprecation" })
    @Test
    public void testCreateGetUpdateAndDeleteOtherName_V2_1() throws InterruptedException, JSONException {
        changeDefaultUserVisibility(org.orcid.jaxb.model.common_v2.Visibility.LIMITED);
        changeCurrentOtherNamesVisibility(org.orcid.jaxb.model.common_v2.Visibility.PUBLIC); 
        ...
        // Create
        ClientResponse response = memberV2_1ApiClient_release.createOtherName(getUser1OrcidId(), newOtherName, accessToken);
        assertNotNull(response);
        assertEquals(ClientResponse.Status.CREATED.getStatusCode(), response.getStatus());
        Map map = response.getMetadata();
        assertNotNull(map);
        ...
        // Get and verify
        response = memberV2_1ApiClient_release.viewOtherNames(getUser1OrcidId(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), response.getStatus());
        org.orcid.jaxb.model.record_v2.OtherNames otherNames = response.getEntity(org.orcid.jaxb.model.record_v2.OtherNames.class);
        assertNotNull(otherNames);
        assertNotNull(otherNames.getOtherNames());
        ...
        // Get it
        response = memberV2_1ApiClient_release.viewOtherName(this.getUser1OrcidId(), putCode, accessToken);
        assertNotNull(response);
        org.orcid.jaxb.model.record_v2.OtherName otherName = response.getEntity(org.orcid.jaxb.model.record_v2.OtherName.class);
        assertNotNull(otherName);
        assertEquals(newOtherName.getContent(), otherName.getContent());
        ...
        // Verify you cant update the visibility
        otherName.setVisibility(updatedVisibility);
        ClientResponse putResponse = memberV2_1ApiClient_release.updateOtherName(this.getUser1OrcidId(), otherName, accessToken);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        org.orcid.jaxb.model.error_v2.OrcidError error = putResponse.getEntity(org.orcid.jaxb.model.error_v2.OrcidError.class);
        assertNotNull(error);
        assertEquals(Integer.valueOf(9035), error.getErrorCode());
        ...
        // Update it
        otherName.setContent("Other Name #1 - Updated");
        response = memberV2_1ApiClient_release.updateOtherName(this.getUser1OrcidId(), otherName, accessToken);
        assertNotNull(response);
        assertEquals(ClientResponse.Status.OK.getStatusCode(), response.getStatus());
        response = memberV2_1ApiClient_release.viewOtherName(this.getUser1OrcidId(), putCode, accessToken);
        assertNotNull(response);
        ...
        // Delete
        response = memberV2_1ApiClient_release.deleteOtherName(this.getUser1OrcidId(), putCode, accessToken);
        assertNotNull(response);
        assertEquals(ClientResponse.Status.NO_CONTENT.getStatusCode(), response.getStatus());
    }    
    ...
    public void testInvalidPutCodeReturns404_V2_1() throws InterruptedException, JSONException {
        ...
        ClientResponse response = memberV2_1ApiClient_release.updateOtherName(getUser1OrcidId(), otherName, accessToken);
        assertNotNull(response);
        assertEquals(ClientResponse.Status.NOT_FOUND.getStatusCode(), response.getStatus());
    }
    ...
    public void testGetOtherNamesWithPublicAPI() throws InterruptedException, JSONException {
        ...
        // V2.1       
        response = publicV2_1ApiClient_release.viewOtherNamesXML(getUser1OrcidId());
        assertEquals(Response.Status.OK.getStatusCode(), response.getStatus());
        org.orcid.jaxb.model.record_v2.OtherNames otherNamesV2_1 = response.getEntity(org.orcid.jaxb.model.record_v2.OtherNames.class);
        assertNotNull(otherNamesV2_1);
        assertNotNull(otherNamesV2_1.getOtherNames());
        assertFalse(otherNamesV2_1.getOtherNames().isEmpty());

        // There should be at least two, one public and one limited
        found1 = false;
        found2 = false;

        for (org.orcid.jaxb.model.record_v2.OtherName otherName : otherNamesV2_1.getOtherNames()) {
            assertEquals(org.orcid.jaxb.model.common_v2.Visibility.PUBLIC, otherName.getVisibility());
            if (otherName.getContent().equals(otherName1)) {
                found1 = true;
    ...
    public void testGetOtherNamesWithMembersAPI() throws InterruptedException, JSONException {
        ...
        //Release
        getResponse = memberV2ApiClient_release.viewOtherNames(getUser1OrcidId(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getResponse.getStatus());
        ...
        //V2.1
        getResponse = memberV2_1ApiClient_release.viewOtherNames(getUser1OrcidId(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getResponse.getStatus());
        org.orcid.jaxb.model.record_v2.OtherNames otherNamesV2_1 = getResponse.getEntity(org.orcid.jaxb.model.record_v2.OtherNames.class);
        assertNotNull(otherNamesV2_1);
        assertNotNull(otherNamesV2_1.getOtherNames());
