...
public class WorksTest extends BlackBoxBaseV3_0 {
    ...
    public void createViewUpdateAndDeleteWork() throws JSONException, InterruptedException, URISyntaxException {
        showMyOrcidPage();
    	changeDefaultUserVisibility(webDriver, org.orcid.jaxb.model.v3.release.common.Visibility.PUBLIC.name());
        long time = System.currentTimeMillis();
        Work workToCreate = (Work) unmarshallFromPath("/record_3.0/samples/read_samples/work-3.0.xml", Work.class);
        ...
        ClientResponse postResponse = memberV3ApiClient.createWorkXml(this.getUser1OrcidId(), workToCreate, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        String locationPath = postResponse.getLocation().getPath();
        assertTrue("Location header path should match pattern, but was " + locationPath, locationPath.matches(".*/v3.0/" + this.getUser1OrcidId() + "/work/\\d+"));
        ...
        ClientResponse putResponse = memberV3ApiClient.updateLocationXml(postResponse.getLocation(), accessToken, gotWork);
        ...
        putResponse = memberV3ApiClient.updateLocationXml(postResponse.getLocation(), accessToken, gotWork);
        assertEquals(Response.Status.OK.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClient.viewLocationXml(postResponse.getLocation(), accessToken);
        ...
        ClientResponse deleteResponse = memberV3ApiClient.deleteWorkXml(this.getUser1OrcidId(), gotWork.getPutCode(), accessToken);
    ...
    public void testWorksWithPartOfRelationshipDontGetGrouped () throws JSONException, InterruptedException, URISyntaxException {
        ...
        Work work2 = (Work) unmarshallFromPath("/record_3.0/samples/read_samples/work-3.0.xml", Work.class);
        work2.setPutCode(null);
        work2.setSource(null);
        work2.setVisibility(Visibility.PUBLIC);
        org.orcid.jaxb.model.v3.release.record.WorkTitle title2 = new org.orcid.jaxb.model.v3.release.record.WorkTitle();
        ...
        Work work3 = (Work) unmarshallFromPath("/record_3.0/samples/read_samples/work-3.0.xml", Work.class);
        work3.setPutCode(null);
        work3.setSource(null);
        work3.setVisibility(Visibility.PUBLIC);
        org.orcid.jaxb.model.v3.release.record.WorkTitle title3 = new org.orcid.jaxb.model.v3.release.record.WorkTitle();
        ...
        //Add the three works
        ClientResponse postResponse = memberV3ApiClient.createWorkXml(this.getUser1OrcidId(), work1, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        Long putCode1 = getPutCodeFromResponse(postResponse);
        
        postResponse = memberV3ApiClient.createWorkXml(this.getUser1OrcidId(), work2, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        Long putCode2 = getPutCodeFromResponse(postResponse);
        
        postResponse = memberV3ApiClient.createWorkXml(this.getUser1OrcidId(), work3, accessTokenForClient2);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        Long putCode3 = getPutCodeFromResponse(postResponse);
        
        ClientResponse activitiesResponse = memberV3ApiClient.viewActivities(this.getUser1OrcidId(), accessTokenForClient1);
        ...
        ClientResponse deleteResponse = memberV3ApiClient.deleteWorkXml(this.getUser1OrcidId(), putCode1, accessTokenForClient1);
        assertNotNull(deleteResponse);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
        
        deleteResponse = memberV3ApiClient.deleteWorkXml(this.getUser1OrcidId(), putCode2, accessTokenForClient1);
        assertNotNull(deleteResponse);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
        
        deleteResponse = memberV3ApiClient.deleteWorkXml(this.getUser1OrcidId(), putCode3, accessTokenForClient2);
        assertNotNull(deleteResponse);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
    }
    ...
    public void testUpdateWorkWithProfileCreationTokenWhenClaimedAndNotSource() throws JSONException, InterruptedException, URISyntaxException {
        ...
        ClientResponse putResponse = memberV3ApiClient.updateLocationXml(postResponse.getLocation(), profileCreateToken, gotWork);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClient.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        Work gotAfterUpdateWork = getAfterUpdateResponse.getEntity(Work.class);
    ...
    public void testCreateBulkWork() throws InterruptedException, JSONException {
        ...
        ClientResponse postResponse = memberV3ApiClient.createWorksJson(this.getUser1OrcidId(), bulk, accessToken);
        assertNotNull(postResponse);
        ...
        for(BulkElement element : bulk.getBulk()) {
            ...
            //Remove the work
            memberV3ApiClient.deleteWorkXml(this.getUser1OrcidId(), work.getPutCode(), accessToken);
        }
    }
    ...
    public void testThreeWithInvalidTypeAllOthersAreFine() throws InterruptedException, JSONException {
        ...
        for(int i = 0; i < bulk.getBulk().size(); i++) {
            ...
            if(i == 3 || i == 5 || i == 7) {
                ...
                case 5:
                    assertEquals(Integer.valueOf(9001), error.getErrorCode());
                    assertTrue(error.getDeveloperMessage().contains("Object must have some value in its @XmlValue field: org.orcid.jaxb.model.v3.release.common.Title"));
                    break;
                case 7:
                    assertEquals(Integer.valueOf(9001), error.getErrorCode());
    ...
    public void testGroupingNormalized() throws InterruptedException, JSONException{
        ...
        postResponse = memberV3ApiClient.createWorkXml(this.getUser1OrcidId(), work2, accessTokenForClient2);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        Long putCode2 = getPutCodeFromResponse(postResponse);
        ...
        deleteResponse = memberV3ApiClient.deleteWorkXml(this.getUser1OrcidId(), putCode2, accessTokenForClient2);
        assertNotNull(deleteResponse);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
