...
public class MemberV3Test extends BlackBoxBaseV3_0 {
    ...
    public void createViewUpdateAndDeleteEducation() throws JSONException, InterruptedException, URISyntaxException {
        Education education = (Education) unmarshallFromPath("/record_3.0/samples/read_samples/education-3.0.xml", Education.class);
        education.setPutCode(null);
        education.setVisibility(Visibility.PUBLIC);
        String accessToken = getAccessToken();
        ClientResponse postResponse = memberV3ApiClientImpl.createEducationXml(this.getUser1OrcidId(), education, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        String locationPath = postResponse.getLocation().getPath();
        assertTrue("Location header path should match pattern, but was " + locationPath,
                locationPath.matches(".*/v3.0/" + this.getUser1OrcidId() + "/education/\\d+"));
        ClientResponse getResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        ...
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotEducation);
        ...
        putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotEducation);
        assertEquals(Response.Status.OK.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        ...
        ClientResponse deleteResponse = memberV3ApiClientImpl.deleteEducationXml(this.getUser1OrcidId(), gotEducation.getPutCode(), accessToken);
    ...
    public void testUpdateEducationWithProfileCreationTokenWhenClaimedAndNotSource() throws JSONException, InterruptedException, URISyntaxException {
        ...
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), profileCreateToken, gotEducation);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        Education gotAfterUpdateEducation = getAfterUpdateResponse.getEntity(Education.class);
    ...
    public void createViewUpdateAndDeleteEmployment() throws JSONException, InterruptedException, URISyntaxException {
        Employment employment = (Employment) unmarshallFromPath("/record_3.0/samples/read_samples/employment-3.0.xml", Employment.class);
        employment.setPutCode(null);
        employment.setVisibility(Visibility.PUBLIC);
        String accessToken = getAccessToken();
        ClientResponse postResponse = memberV3ApiClientImpl.createEmploymentXml(this.getUser1OrcidId(), employment, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        String locationPath = postResponse.getLocation().getPath();
        assertTrue("Location header path should match pattern, but was " + locationPath,
                locationPath.matches(".*/v3.0/" + this.getUser1OrcidId() + "/employment/\\d+"));
        ClientResponse getResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getResponse.getStatus());
        ...
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotEmployment);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        OrcidError error = putResponse.getEntity(OrcidError.class);
        assertNotNull(error);
        assertEquals(Integer.valueOf(9035), error.getErrorCode());
        ...
        putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotEmployment);
        assertEquals(Response.Status.OK.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        ...
        ClientResponse deleteResponse = memberV3ApiClientImpl.deleteEmploymentXml(this.getUser1OrcidId(), gotEmployment.getPutCode(), accessToken);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
    }
    ...
    public void testUpdateEmploymentWithProfileCreationTokenWhenClaimedAndNotSource() throws JSONException, InterruptedException, URISyntaxException {
        ...
        String profileCreateToken = oauthHelper.getClientCredentialsAccessToken(this.getClient2ClientId(), this.getClient2ClientSecret(),
                ScopePathType.ORCID_PROFILE_CREATE);
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), profileCreateToken, gotEmployment);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        Employment gotAfterUpdateEmployment = getAfterUpdateResponse.getEntity(Employment.class);
    ...
    public void createViewUpdateAndDeleteFunding() throws JSONException, InterruptedException, URISyntaxException {
        ...
        Funding funding = (Funding) unmarshallFromPath("/record_3.0/samples/read_samples/funding-3.0.xml", Funding.class);
        ...
        String accessToken = getAccessToken();
        ClientResponse postResponse = memberV3ApiClientImpl.createFundingXml(this.getUser1OrcidId(), funding, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        String locationPath = postResponse.getLocation().getPath();
        assertTrue("Location header path should match pattern, but was " + locationPath, locationPath.matches(".*/v3.0/" + this.getUser1OrcidId() + "/funding/\\d+"));
        ClientResponse getResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getResponse.getStatus());
        ...
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotFunding);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        OrcidError error = putResponse.getEntity(OrcidError.class);
        assertNotNull(error);
        assertEquals(Integer.valueOf(9035), error.getErrorCode());
        ...
        putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotFunding);
        assertEquals(Response.Status.OK.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        ...
        ClientResponse deleteResponse = memberV3ApiClientImpl.deleteFundingXml(this.getUser1OrcidId(), gotFunding.getPutCode(), accessToken);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
    }
    ...
    public void testUpdateFundingWithProfileCreationTokenWhenClaimedAndNotSource() throws JSONException, InterruptedException, URISyntaxException {
        ...
        String profileCreateToken = oauthHelper.getClientCredentialsAccessToken(this.getClient2ClientId(), this.getClient2ClientSecret(),
                ScopePathType.ORCID_PROFILE_CREATE);
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), profileCreateToken, gotFunding);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        Funding gotAfterUpdateFunding = getAfterUpdateResponse.getEntity(Funding.class);
    ...
    public void createViewUpdateAndDeletePeerReview() throws JSONException, InterruptedException, URISyntaxException {
        long time = System.currentTimeMillis();
        PeerReview peerReviewToCreate = (PeerReview) unmarshallFromPath("/record_3.0/samples/read_samples/peer-review-3.0.xml", PeerReview.class);
        ...
        ClientResponse postResponse = memberV3ApiClientImpl.createPeerReviewXml(this.getUser1OrcidId(), peerReviewToCreate, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        String locationPath = postResponse.getLocation().getPath();
        assertTrue("Location header path should match pattern, but was " + locationPath,
                locationPath.matches(".*/v3.0/" + this.getUser1OrcidId() + "/peer-review/\\d+"));
        ClientResponse getResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getResponse.getStatus());
        ...
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotPeerReview);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        OrcidError error = putResponse.getEntity(OrcidError.class);
        assertNotNull(error);
        assertEquals(Integer.valueOf(9035), error.getErrorCode());
        ...
        putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotPeerReview);
        assertEquals(Response.Status.OK.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        ...
        ClientResponse deleteResponse = memberV3ApiClientImpl.deletePeerReviewXml(this.getUser1OrcidId(), gotAfterUpdateWork.getPutCode(), accessToken);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
    }
    ...
    public void testUpdatePeerReviewWithProfileCreationTokenWhenClaimedAndNotSource() throws JSONException, InterruptedException, URISyntaxException {
        ...
        String profileCreateToken = oauthHelper.getClientCredentialsAccessToken(this.getClient2ClientId(), this.getClient2ClientSecret(),
                ScopePathType.ORCID_PROFILE_CREATE);
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), profileCreateToken, gotPeerReview);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        ...
        ClientResponse deleteResponse = memberV3ApiClientImpl.deletePeerReviewXml(this.getUser1OrcidId(), gotAfterUpdatePeerReview.getPutCode(), accessToken);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
    }
    ...
    public void testViewActivitiesSummaries() throws JSONException, InterruptedException, URISyntaxException {
        ...
        Distinction distinction = (Distinction) unmarshallFromPath("/record_3.0/samples/read_samples/distinction-3.0.xml", Distinction.class);
        ...
        InvitedPosition invitedPosition = (InvitedPosition) unmarshallFromPath("/record_3.0/samples/read_samples/invited-position-3.0.xml",
                InvitedPosition.class);
        invitedPosition.setPutCode(null);
        invitedPosition.setVisibility(Visibility.PUBLIC);

        Membership membership = (Membership) unmarshallFromPath("/record_3.0/samples/read_samples/membership-3.0.xml", Membership.class);
        membership.setPutCode(null);
        membership.setVisibility(Visibility.PUBLIC);

        Qualification qualification = (Qualification) unmarshallFromPath("/record_3.0/samples/read_samples/qualification-3.0.xml", Qualification.class);
        qualification.setPutCode(null);
        qualification.setVisibility(Visibility.PUBLIC);

        Service service = (Service) unmarshallFromPath("/record_3.0/samples/read_samples/service-3.0.xml", Service.class);
        ...
        Work work = (Work) unmarshallFromPath("/record_3.0/samples/read_samples/work-3.0.xml", Work.class);
        ...
        PeerReview peerReview = (PeerReview) unmarshallFromPath("/record_3.0/samples/read_samples/peer-review-3.0.xml", PeerReview.class);
        ...
        ClientResponse postResponse = memberV3ApiClientImpl.createDistinctionXml(this.getUser1OrcidId(), distinction, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());

        postResponse = memberV3ApiClientImpl.createEducationXml(this.getUser1OrcidId(), education, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());

        postResponse = memberV3ApiClientImpl.createEmploymentXml(this.getUser1OrcidId(), employment, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());

        postResponse = memberV3ApiClientImpl.createInvitedPositionXml(this.getUser1OrcidId(), invitedPosition, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());

        postResponse = memberV3ApiClientImpl.createMembershipXml(this.getUser1OrcidId(), membership, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());

        postResponse = memberV3ApiClientImpl.createQualificationXml(this.getUser1OrcidId(), qualification, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());

        postResponse = memberV3ApiClientImpl.createServiceXml(this.getUser1OrcidId(), service, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        ...
        postResponse = memberV3ApiClientImpl.createFundingXml(this.getUser1OrcidId(), funding, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        ...
        postResponse = memberV3ApiClientImpl.createFundingXml(this.getUser1OrcidId(), funding, accessTokenForClient2);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        ...
        postResponse = memberV3ApiClientImpl.createWorkXml(this.getUser1OrcidId(), work, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        ...
        // Add 2, with the same ext ids +1
        postResponse = memberV3ApiClientImpl.createWorkXml(this.getUser1OrcidId(), work, accessTokenForClient2);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        ...
        postResponse = memberV3ApiClientImpl.createPeerReviewXml(this.getUser1OrcidId(), peerReview, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        peerReview.setGroupId(groupRecords.get(0).getGroupId());
        ...
        // Add 2, with the same ext ids +1
        postResponse = memberV3ApiClientImpl.createPeerReviewXml(this.getUser1OrcidId(), peerReview, accessTokenForClient2);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        ...
        ClientResponse activitiesResponse = memberV3ApiClientImpl.viewActivities(this.getUser1OrcidId(), accessTokenForClient1);
        ...
        ClientResponse deleteResponse = memberV3ApiClientImpl.deleteDistinctionXml(this.getUser1OrcidId(), distinctionPutCode, accessTokenForClient1);
        assertNotNull(deleteResponse);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());

        deleteResponse = memberV3ApiClientImpl.deleteEmploymentXml(this.getUser1OrcidId(), employmentPutCode, accessTokenForClient1);
        assertNotNull(deleteResponse);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());

        deleteResponse = memberV3ApiClientImpl.deleteEducationXml(this.getUser1OrcidId(), educationPutCode, accessTokenForClient1);
        assertNotNull(deleteResponse);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());

        deleteResponse = memberV3ApiClientImpl.deleteInvitedPositionXml(this.getUser1OrcidId(), invitedPositionPutCode, accessTokenForClient1);
        assertNotNull(deleteResponse);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());

        deleteResponse = memberV3ApiClientImpl.deleteMembershipXml(this.getUser1OrcidId(), membershipPutCode, accessTokenForClient1);
        assertNotNull(deleteResponse);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());

        deleteResponse = memberV3ApiClientImpl.deleteQualificationXml(this.getUser1OrcidId(), qualificationPutCode, accessTokenForClient1);
        assertNotNull(deleteResponse);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());

        deleteResponse = memberV3ApiClientImpl.deleteServiceXml(this.getUser1OrcidId(), servicePutCode, accessTokenForClient1);
        assertNotNull(deleteResponse);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());

        for (Long putCode : fundingPutCodes) {
            deleteResponse = memberV3ApiClientImpl.deleteFundingXml(this.getUser1OrcidId(), putCode, accessTokenForClient1);
            assertNotNull(deleteResponse);
            if (Response.Status.NO_CONTENT.getStatusCode() != deleteResponse.getStatus()) {
                ...
                deleteResponse = memberV3ApiClientImpl.deleteFundingXml(this.getUser1OrcidId(), putCode, accessTokenForClient2);
                assertNotNull(deleteResponse);
        ...
        for (Long putCode : worksPutCodes) {
            deleteResponse = memberV3ApiClientImpl.deleteWorkXml(this.getUser1OrcidId(), putCode, accessTokenForClient1);
            assertNotNull(deleteResponse);
            if (Response.Status.NO_CONTENT.getStatusCode() != deleteResponse.getStatus()) {
                // It belongs to client2, so, delete it with client2 token
                deleteResponse = memberV3ApiClientImpl.deleteWorkXml(this.getUser1OrcidId(), putCode, accessTokenForClient2);
                assertNotNull(deleteResponse);
        ...
        for (Long putCode : peerReviewPutCodes) {
            deleteResponse = memberV3ApiClientImpl.deletePeerReviewXml(this.getUser1OrcidId(), putCode, accessTokenForClient1);
            assertNotNull(deleteResponse);
            if (Response.Status.NO_CONTENT.getStatusCode() != deleteResponse.getStatus()) {
                // It belongs to client2, so, delete it with client2 token
                deleteResponse = memberV3ApiClientImpl.deletePeerReviewXml(this.getUser1OrcidId(), putCode, accessTokenForClient2);
                assertNotNull(deleteResponse);
    ...
    public void testPeerReviewMustHaveAtLeastOneExtId() throws JSONException, InterruptedException, URISyntaxException {
        ...
        ClientResponse postResponse = memberV3ApiClientImpl.createPeerReviewXml(this.getUser1OrcidId(), peerReview, accessToken);
        assertNotNull(postResponse);
    ...
    public void testTokenWorksOnlyForTheScopeItWasIssued() throws JSONException, InterruptedException, URISyntaxException {
        ...
        Work work1 = (Work) unmarshallFromPath("/record_3.0/samples/read_samples/work-3.0.xml", Work.class);
        work1.setPutCode(null);
        work1.getExternalIdentifiers().getExternalIdentifier().clear();
        org.orcid.jaxb.model.v3.release.record.WorkTitle title1 = new org.orcid.jaxb.model.v3.release.record.WorkTitle();
        ...
        // Add the work
        ClientResponse postResponse = memberV3ApiClientImpl.createWorkXml(this.getUser1OrcidId(), work1, accessToken);
        assertNotNull(postResponse);
        ...
        // Add the funding
        postResponse = memberV3ApiClientImpl.createFundingXml(this.getUser1OrcidId(), funding, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        // Delete funding
        ...
        ClientResponse deleteResponse = memberV3ApiClientImpl.deleteFundingXml(this.getUser1OrcidId(), putCode, accessToken);
        assertNotNull(deleteResponse);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
    }
    ...
    public void testAddPeerReviewWithInvalidGroupingId() throws JSONException, InterruptedException, URISyntaxException {
        ...
        postResponse = memberV3ApiClientImpl.createPeerReviewXml(this.getUser1OrcidId(), peerReview, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.BAD_REQUEST.getStatusCode(), postResponse.getStatus());
    ...
    public void createViewUpdateAndDeleteDistinction() throws JSONException, InterruptedException, URISyntaxException {
        ...
        distinction.setVisibility(Visibility.PUBLIC);
        String accessToken = getAccessToken();
        ClientResponse postResponse = memberV3ApiClientImpl.createDistinctionXml(this.getUser1OrcidId(), distinction, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        String locationPath = postResponse.getLocation().getPath();
        assertTrue("Location header path should match pattern, but was " + locationPath,
                locationPath.matches(".*/v3.0/" + this.getUser1OrcidId() + "/distinction/\\d+"));
        ClientResponse getResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getResponse.getStatus());
        ...
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotDistinction);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        OrcidError error = putResponse.getEntity(OrcidError.class);
        assertNotNull(error);
        assertEquals(Integer.valueOf(9035), error.getErrorCode());
        ...
        putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotDistinction);
        assertEquals(Response.Status.OK.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        ...
        ClientResponse deleteResponse = memberV3ApiClientImpl.deleteDistinctionXml(this.getUser1OrcidId(), gotDistinction.getPutCode(), accessToken);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
    }
    ...
    public void testUpdateDistinctionWithProfileCreationTokenWhenClaimedAndNotSource() throws JSONException, InterruptedException, URISyntaxException {
        ...
        String profileCreateToken = oauthHelper.getClientCredentialsAccessToken(this.getClient2ClientId(), this.getClient2ClientSecret(),
                ScopePathType.ORCID_PROFILE_CREATE);
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), profileCreateToken, gotDistinction);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        Distinction gotAfterUpdateDistinction = getAfterUpdateResponse.getEntity(Distinction.class);
    ...
    public void createViewUpdateAndDeleteInvitedPosition() throws JSONException, InterruptedException, URISyntaxException {
        ...
        invitedPosition.setVisibility(Visibility.PUBLIC);
        String accessToken = getAccessToken();
        ClientResponse postResponse = memberV3ApiClientImpl.createInvitedPositionXml(this.getUser1OrcidId(), invitedPosition, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        String locationPath = postResponse.getLocation().getPath();
        assertTrue("Location header path should match pattern, but was " + locationPath,
                locationPath.matches(".*/v3.0/" + this.getUser1OrcidId() + "/invited-position/\\d+"));
        ClientResponse getResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getResponse.getStatus());
        ...
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotInvitedPosition);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        OrcidError error = putResponse.getEntity(OrcidError.class);
        assertNotNull(error);
        assertEquals(Integer.valueOf(9035), error.getErrorCode());
        ...
        putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotInvitedPosition);
        assertEquals(Response.Status.OK.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        ...
        ClientResponse deleteResponse = memberV3ApiClientImpl.deleteInvitedPositionXml(this.getUser1OrcidId(), gotInvitedPosition.getPutCode(), accessToken);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
    }
    ...
    public void testUpdateInvitedPositionWithProfileCreationTokenWhenClaimedAndNotSource() throws JSONException, InterruptedException, URISyntaxException {
        ...
        String profileCreateToken = oauthHelper.getClientCredentialsAccessToken(this.getClient2ClientId(), this.getClient2ClientSecret(),
                ScopePathType.ORCID_PROFILE_CREATE);
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), profileCreateToken, gotInvitedPosition);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        InvitedPosition gotAfterUpdateInvitedPosition = getAfterUpdateResponse.getEntity(InvitedPosition.class);
    ...
    public void createViewUpdateAndDeleteMembership() throws JSONException, InterruptedException, URISyntaxException {
        ...
        membership.setVisibility(Visibility.PUBLIC);
        String accessToken = getAccessToken();
        ClientResponse postResponse = memberV3ApiClientImpl.createMembershipXml(this.getUser1OrcidId(), membership, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        String locationPath = postResponse.getLocation().getPath();
        assertTrue("Location header path should match pattern, but was " + locationPath,
                locationPath.matches(".*/v3.0/" + this.getUser1OrcidId() + "/membership/\\d+"));
        ClientResponse getResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getResponse.getStatus());
        ...
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotMembership);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        OrcidError error = putResponse.getEntity(OrcidError.class);
        assertNotNull(error);
        assertEquals(Integer.valueOf(9035), error.getErrorCode());
        ...
        putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotMembership);
        assertEquals(Response.Status.OK.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        ...
        ClientResponse deleteResponse = memberV3ApiClientImpl.deleteMembershipXml(this.getUser1OrcidId(), gotMembership.getPutCode(), accessToken);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
    }
    ...
    public void testUpdateMembershipWithProfileCreationTokenWhenClaimedAndNotSource() throws JSONException, InterruptedException, URISyntaxException {
        ...
        String profileCreateToken = oauthHelper.getClientCredentialsAccessToken(this.getClient2ClientId(), this.getClient2ClientSecret(),
                ScopePathType.ORCID_PROFILE_CREATE);
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), profileCreateToken, gotMembership);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        Membership gotAfterUpdateMembership = getAfterUpdateResponse.getEntity(Membership.class);
    ...
    public void createViewUpdateAndDeleteQualification() throws JSONException, InterruptedException, URISyntaxException {
        ...
        qualification.setVisibility(Visibility.PUBLIC);
        String accessToken = getAccessToken();
        ClientResponse postResponse = memberV3ApiClientImpl.createQualificationXml(this.getUser1OrcidId(), qualification, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        String locationPath = postResponse.getLocation().getPath();
        assertTrue("Location header path should match pattern, but was " + locationPath,
                locationPath.matches(".*/v3.0/" + this.getUser1OrcidId() + "/qualification/\\d+"));
        ClientResponse getResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getResponse.getStatus());
        ...
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotQualification);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        OrcidError error = putResponse.getEntity(OrcidError.class);
        assertNotNull(error);
        assertEquals(Integer.valueOf(9035), error.getErrorCode());
        ...
        putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotQualification);
        assertEquals(Response.Status.OK.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        ...
        ClientResponse deleteResponse = memberV3ApiClientImpl.deleteQualificationXml(this.getUser1OrcidId(), gotQualification.getPutCode(), accessToken);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
    }
    ...
    public void testUpdateQualificationWithProfileCreationTokenWhenClaimedAndNotSource() throws JSONException, InterruptedException, URISyntaxException {
        ...
        String profileCreateToken = oauthHelper.getClientCredentialsAccessToken(this.getClient2ClientId(), this.getClient2ClientSecret(),
                ScopePathType.ORCID_PROFILE_CREATE);
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), profileCreateToken, gotQualification);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        Qualification gotAfterUpdateQualification = getAfterUpdateResponse.getEntity(Qualification.class);
    ...
    public void createViewUpdateAndDeleteService() throws JSONException, InterruptedException, URISyntaxException {
        ...
        service.setVisibility(Visibility.PUBLIC);
        String accessToken = getAccessToken();
        ClientResponse postResponse = memberV3ApiClientImpl.createServiceXml(this.getUser1OrcidId(), service, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        String locationPath = postResponse.getLocation().getPath();
        assertTrue("Location header path should match pattern, but was " + locationPath, locationPath.matches(".*/v3.0/" + this.getUser1OrcidId() + "/service/\\d+"));
        ClientResponse getResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getResponse.getStatus());
        ...
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotService);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        OrcidError error = putResponse.getEntity(OrcidError.class);
        assertNotNull(error);
        assertEquals(Integer.valueOf(9035), error.getErrorCode());
        ...
        putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), accessToken, gotService);
        assertEquals(Response.Status.OK.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        ...
        ClientResponse deleteResponse = memberV3ApiClientImpl.deleteServiceXml(this.getUser1OrcidId(), gotService.getPutCode(), accessToken);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
    }
    ...
    public void testUpdateServiceWithProfileCreationTokenWhenClaimedAndNotSource() throws JSONException, InterruptedException, URISyntaxException {
        ...
        String profileCreateToken = oauthHelper.getClientCredentialsAccessToken(this.getClient2ClientId(), this.getClient2ClientSecret(),
                ScopePathType.ORCID_PROFILE_CREATE);
        ClientResponse putResponse = memberV3ApiClientImpl.updateLocationXml(postResponse.getLocation(), profileCreateToken, gotService);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV3ApiClientImpl.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        Service gotAfterUpdateService = getAfterUpdateResponse.getEntity(Service.class);
