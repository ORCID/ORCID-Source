package org.orcid.integration.blackbox.api.v2_1.release;
...
public class MemberV2_1Test extends BlackBoxBaseV2_1Release {    
    ...
    public void createViewUpdateAndDeletePeerReview() throws JSONException, InterruptedException, URISyntaxException {
        ...
        ClientResponse putResponse = memberV2_1ApiClient.updateLocationXml(postResponse.getLocation(), accessToken, gotPeerReview);
        assertEquals(Response.Status.FORBIDDEN.getStatusCode(), putResponse.getStatus());
        OrcidError error = putResponse.getEntity(OrcidError.class);
        assertNotNull(error);
        assertEquals(Integer.valueOf(9035), error.getErrorCode());
        ...
        putResponse = memberV2_1ApiClient.updateLocationXml(postResponse.getLocation(), accessToken, gotPeerReview);
        assertEquals(Response.Status.OK.getStatusCode(), putResponse.getStatus());
        ClientResponse getAfterUpdateResponse = memberV2_1ApiClient.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getAfterUpdateResponse.getStatus());
        ...
        ClientResponse deleteResponse = memberV2_1ApiClient.deletePeerReviewXml(this.getUser1OrcidId(), gotAfterUpdateWork.getPutCode(), accessToken);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
    }
    ...
    public void testViewActivitiesSummaries() throws JSONException, InterruptedException, URISyntaxException {
        ...
        ClientResponse postResponse = memberV2_1ApiClient.createEducationXml(this.getUser1OrcidId(), education, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        
        postResponse = memberV2_1ApiClient.createEmploymentXml(this.getUser1OrcidId(), employment, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        /**
        ...
        postResponse = memberV2_1ApiClient.createFundingXml(this.getUser1OrcidId(), funding, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        ...
        postResponse = memberV2_1ApiClient.createFundingXml(this.getUser1OrcidId(), funding, accessTokenForClient2);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        ...
        postResponse = memberV2_1ApiClient.createWorkXml(this.getUser1OrcidId(), work, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        ...
        // Add 2, with the same ext ids +1
        postResponse = memberV2_1ApiClient.createWorkXml(this.getUser1OrcidId(), work, accessTokenForClient2);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        ...
        postResponse = memberV2_1ApiClient.createPeerReviewXml(this.getUser1OrcidId(), peerReview, accessTokenForClient1);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        peerReview.setGroupId(groupRecords.get(0).getGroupId());
        ...
        // Add 2, with the same ext ids +1
        postResponse = memberV2_1ApiClient.createPeerReviewXml(this.getUser1OrcidId(), peerReview, accessTokenForClient2);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        ...
        ClientResponse deleteResponse = memberV2_1ApiClient.deleteEmploymentXml(this.getUser1OrcidId(), employmentPutCode, accessTokenForClient1);
        assertNotNull(deleteResponse);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
                        
        deleteResponse = memberV2_1ApiClient.deleteEducationXml(this.getUser1OrcidId(), educationPutCode, accessTokenForClient1);
        assertNotNull(deleteResponse);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
        
        for(Long putCode : fundingPutCodes) {
            deleteResponse = memberV2_1ApiClient.deleteFundingXml(this.getUser1OrcidId(), putCode, accessTokenForClient1);
            assertNotNull(deleteResponse);
            if(Response.Status.NO_CONTENT.getStatusCode() != deleteResponse.getStatus()) {
                ...
                deleteResponse = memberV2_1ApiClient.deleteFundingXml(this.getUser1OrcidId(), putCode, accessTokenForClient2);
                assertNotNull(deleteResponse);
        ...
        for(Long putCode : worksPutCodes) {
            deleteResponse = memberV2_1ApiClient.deleteWorkXml(this.getUser1OrcidId(), putCode, accessTokenForClient1);
            assertNotNull(deleteResponse);
            if(Response.Status.NO_CONTENT.getStatusCode() != deleteResponse.getStatus()) {
                //It belongs to client2, so, delete it with client2 token
                deleteResponse = memberV2_1ApiClient.deleteWorkXml(this.getUser1OrcidId(), putCode, accessTokenForClient2);
                assertNotNull(deleteResponse);
        ...
        for(Long putCode : peerReviewPutCodes) {
            deleteResponse = memberV2_1ApiClient.deletePeerReviewXml(this.getUser1OrcidId(), putCode, accessTokenForClient1);
            assertNotNull(deleteResponse);
            if(Response.Status.NO_CONTENT.getStatusCode() != deleteResponse.getStatus()) {
                //It belongs to client2, so, delete it with client2 token
                deleteResponse = memberV2_1ApiClient.deletePeerReviewXml(this.getUser1OrcidId(), putCode, accessTokenForClient2);
                assertNotNull(deleteResponse);
    ...
    public void testAddPeerReviewWithInvalidGroupingId() throws JSONException, InterruptedException, URISyntaxException {
        ...
        postResponse = memberV2_1ApiClient.createPeerReviewXml(this.getUser1OrcidId(), peerReview, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.BAD_REQUEST.getStatusCode(), postResponse.getStatus());
