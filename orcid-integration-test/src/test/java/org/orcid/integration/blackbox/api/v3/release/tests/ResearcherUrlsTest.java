...
public class ResearcherUrlsTest extends BlackBoxBaseV3_0 {
    ...
    public static void setup() {
        ...
        changeResearcherUrlsVisibility(org.orcid.jaxb.model.v3.release.common.Visibility.PUBLIC.name());
        saveResearcherUrlsModal();
        changeDefaultUserVisibility(webDriver, org.orcid.jaxb.model.v3.release.common.Visibility.PUBLIC.name(), false);
    }
    ...
    public void testCreateGetUpdateAndDeleteResearcherUrl() throws InterruptedException, JSONException, URISyntaxException {
        ...
        org.orcid.jaxb.model.v3.release.record.ResearcherUrl rUrlToCreate = new org.orcid.jaxb.model.v3.release.record.ResearcherUrl();
        long time = System.currentTimeMillis();
        String url = "http://test.orcid.org/test/" + time;
        rUrlToCreate.setUrl(new org.orcid.jaxb.model.v3.release.common.Url(url));
        rUrlToCreate.setUrlName(url);

        // Create
        ClientResponse postResponse = memberV3ApiClient.createResearcherUrls(getUser1OrcidId(), rUrlToCreate, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        String locationPath = postResponse.getLocation().getPath();
        assertTrue("Location header path should match pattern, but was " + locationPath, locationPath.matches(".*/v3.0/" + getUser1OrcidId() + "/researcher-urls/\\d+"));

        // Read
        ClientResponse getResponse = memberV3ApiClient.viewLocationXml(postResponse.getLocation(), accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), getResponse.getStatus());
        org.orcid.jaxb.model.v3.release.record.ResearcherUrl gotResearcherUrl = getResponse.getEntity(org.orcid.jaxb.model.v3.release.record.ResearcherUrl.class);
        ...
        org.orcid.jaxb.model.v3.release.common.Visibility originalVisibility = gotResearcherUrl.getVisibility();
        org.orcid.jaxb.model.v3.release.common.Visibility updatedVisibility = org.orcid.jaxb.model.v3.release.common.Visibility.PRIVATE.equals(originalVisibility)
                ? org.orcid.jaxb.model.v3.release.common.Visibility.LIMITED : org.orcid.jaxb.model.v3.release.common.Visibility.PRIVATE;

        // Verify you cant update the visibility
        gotResearcherUrl.setVisibility(updatedVisibility);
        ClientResponse putResponse = memberV3ApiClient.updateLocationXml(postResponse.getLocation(), accessToken, gotResearcherUrl);
        ...
        // Update
        org.orcid.jaxb.model.v3.release.common.LastModifiedDate initialLastModified = gotResearcherUrl.getLastModifiedDate();
        ...
        ClientResponse updatedResearcherUrlResponse = memberV3ApiClient.updateResearcherUrls(getUser1OrcidId(), gotResearcherUrl, accessToken);
        ...
        org.orcid.jaxb.model.v3.release.record.ResearcherUrl updatedResearcherUrl = updatedResearcherUrlResponse.getEntity(org.orcid.jaxb.model.v3.release.record.ResearcherUrl.class);
        ...
        // default
        assertEquals(org.orcid.jaxb.model.v3.release.common.Visibility.PUBLIC, updatedResearcherUrl.getVisibility());
        assertFalse(initialLastModified.equals(updatedResearcherUrl.getLastModifiedDate()));

        // Delete
        ClientResponse deleteResponse = memberV3ApiClient.deleteResearcherUrl(getUser1OrcidId(), gotResearcherUrl.getPutCode(), accessToken);
    ...
    public void testCantAddDuplicatedResearcherUrl() throws InterruptedException, JSONException, URISyntaxException {
        ...
        org.orcid.jaxb.model.v3.release.record.ResearcherUrl rUrlToCreate = new org.orcid.jaxb.model.v3.release.record.ResearcherUrl();
        rUrlToCreate.setUrl(new org.orcid.jaxb.model.v3.release.common.Url("http://newurl.com/" + now));
        rUrlToCreate.setUrlName("url-name-" + System.currentTimeMillis());
        rUrlToCreate.setVisibility(org.orcid.jaxb.model.v3.release.common.Visibility.PUBLIC);
        ...
        // Add it again
        postResponse = memberV3ApiClient.createResearcherUrls(getUser1OrcidId(), rUrlToCreate, accessToken);
        assertNotNull(postResponse);
        ...
        postResponse = memberV3ApiClient.createResearcherUrls(getUser1OrcidId(), rUrlToCreate, otherClientToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.CREATED.getStatusCode(), postResponse.getStatus());
        ...
        // Delete both
        ClientResponse deleteResponse = memberV3ApiClient.deleteResearcherUrl(getUser1OrcidId(), putCode1, accessToken);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
        deleteResponse = memberV3ApiClient.deleteResearcherUrl(getUser1OrcidId(), putCode2, otherClientToken);
        assertEquals(Response.Status.NO_CONTENT.getStatusCode(), deleteResponse.getStatus());
    }
    ...
    public void testTryingToAddInvalidResearcherUrls() throws InterruptedException, JSONException, URISyntaxException {
        ...
        assertNotNull(accessToken);
        org.orcid.jaxb.model.v3.release.record.ResearcherUrl rUrlToCreate = new org.orcid.jaxb.model.v3.release.record.ResearcherUrl();
        rUrlToCreate.setUrl(new org.orcid.jaxb.model.v3.release.common.Url(""));
        ...
        rUrlToCreate.setUrl(new org.orcid.jaxb.model.v3.release.common.Url(_2001Chars));
        postResponse = memberV3ApiClient.createResearcherUrls(getUser1OrcidId(), rUrlToCreate, accessToken);
        assertNotNull(postResponse);
        assertEquals(Response.Status.BAD_REQUEST.getStatusCode(), postResponse.getStatus());

        rUrlToCreate.setUrl(new org.orcid.jaxb.model.v3.release.common.Url("http://myurl.com"));
    ...
    public void testInvalidPutCodeReturns404() throws InterruptedException, JSONException {
        ...
        org.orcid.jaxb.model.v3.release.record.ResearcherUrl rUrlToCreate = new org.orcid.jaxb.model.v3.release.record.ResearcherUrl();
        rUrlToCreate.setUrl(new org.orcid.jaxb.model.v3.release.common.Url("http://newurl.com/" + System.currentTimeMillis()));
        rUrlToCreate.setUrlName("url-name-" + System.currentTimeMillis());
        rUrlToCreate.setVisibility(org.orcid.jaxb.model.v3.release.common.Visibility.PUBLIC);
        rUrlToCreate.setPutCode(1234567890L);

        ClientResponse response = memberV3ApiClient.updateResearcherUrls(getUser1OrcidId(), rUrlToCreate, accessToken);
    ...
    public void testGetWithPublicAPI() throws InterruptedException, JSONException {
        ...
        org.orcid.jaxb.model.v3.release.record.ResearcherUrls researcherUrls = getAllResponse.getEntity(org.orcid.jaxb.model.v3.release.record.ResearcherUrls.class);
        assertNotNull(researcherUrls);
        assertNotNull(researcherUrls.getResearcherUrls());
        for (org.orcid.jaxb.model.v3.release.record.ResearcherUrl rUrl : researcherUrls.getResearcherUrls()) {
            assertEquals(org.orcid.jaxb.model.v3.release.common.Visibility.PUBLIC, rUrl.getVisibility());
        ...
        showMyOrcidPage();
        openEditResearcherUrlsModal();
        changeResearcherUrlsVisibility(org.orcid.jaxb.model.v3.release.common.Visibility.LIMITED.name());
        saveResearcherUrlsModal();

        getAllResponse = publicV3ApiClient.viewResearcherUrlsXML(getUser1OrcidId());
        assertNotNull(getAllResponse);
        researcherUrls = getAllResponse.getEntity(org.orcid.jaxb.model.v3.release.record.ResearcherUrls.class);
        assertNotNull(researcherUrls);
        assertNotNull(researcherUrls.getResearcherUrls());
    ...
    public void testGetWithMembersAPI() throws InterruptedException, JSONException {
        ...
        ClientResponse getAllResponse = memberV3ApiClient.getResearcherUrls(getUser1OrcidId(), accessToken);
        assertNotNull(getAllResponse);
        org.orcid.jaxb.model.v3.release.record.ResearcherUrls researcherUrls = getAllResponse.getEntity(org.orcid.jaxb.model.v3.release.record.ResearcherUrls.class);
        assertNotNull(researcherUrls);
        assertNotNull(researcherUrls.getResearcherUrls());
        ...
        showMyOrcidPage();
        openEditResearcherUrlsModal();
        changeResearcherUrlsVisibility(org.orcid.jaxb.model.v3.release.common.Visibility.PRIVATE.name());
        saveResearcherUrlsModal();

        getAllResponse = memberV3ApiClient.getResearcherUrls(getUser1OrcidId(), accessToken);
        assertNotNull(getAllResponse);
        researcherUrls = getAllResponse.getEntity(org.orcid.jaxb.model.v3.release.record.ResearcherUrls.class);
        assertNotNull(researcherUrls);
        assertNotNull(researcherUrls.getResearcherUrls());
