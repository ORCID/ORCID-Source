...
public class NotificationsTest {
    ...
    @Resource(name = "notificationsClient_v3_0")
    private NotificationsApiClientImpl<org.orcid.jaxb.model.v3.release.notification.permission.NotificationPermission> notificationsClient_V3_0;
    ...
    public void createPermissionNotification() throws JSONException {
        ...
        ClientResponse response = notificationsClient_V3_0.addPermissionNotificationXml(testUser1OrcidId, notification, accessToken);
    ...
    public void flagAsArchived() throws JSONException {
        ...
        ClientResponse archiveResponse = notificationsClient_V3_0.flagAsArchivedPermissionNotificationXml(testUser1OrcidId, putCode, accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), archiveResponse.getStatus());

        ClientResponse viewAfterArchiveResponse = notificationsClient_V3_0.viewPermissionNotificationXml(testUser1OrcidId, putCode, accessToken);
