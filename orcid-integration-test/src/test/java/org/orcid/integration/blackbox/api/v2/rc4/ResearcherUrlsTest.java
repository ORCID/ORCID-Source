...
public class ResearcherUrlsTest extends BlackBoxBaseRC4 {
    ...
    public void testResearcherUrl() throws InterruptedException, JSONException, URISyntaxException {
        ...
        assertTrue("Location header path should match pattern, but was " + locationPath, locationPath.matches(".*/v2.0_rc4/" + getUser1OrcidId() + "/researcher-urls/\\d+"));
    ...
    public void testGetWithPublicAPI() throws InterruptedException, JSONException {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if(i == 3) {
                ...
                changeDefaultUserVisibility(webDriver, org.orcid.jaxb.model.common_rc4.Visibility.PRIVATE);
