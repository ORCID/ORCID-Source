...
public class NotificationsTest {
    ...
    @Resource(name = "notificationsClient_rc4")
    private NotificationsApiClientImpl<org.orcid.jaxb.model.notification.permission_rc4.NotificationPermission> notificationsClient;
