...
public class GroupIdRecordTest extends BlackBoxBaseV3_0 {
    ...
    public void cleanUpOldTest() throws JSONException {
        ...
        int page = 1;
        org.orcid.jaxb.model.v3.release.groupid.GroupIdRecords groupsContainer = memberV3ApiClient.getGroupIdRecords(100, page, token).getEntity(org.orcid.jaxb.model.v3.release.groupid.GroupIdRecords.class);
        
        while (groupsContainer.getTotal() > 0) {
            for (org.orcid.jaxb.model.v3.release.groupid.GroupIdRecord groupIdRecord : groupsContainer.getGroupIdRecord())
                if (groupIdRecord.getGroupId().startsWith("orcid-generated:bb_test:"))
                    putsToDelete.add(groupIdRecord.getPutCode());
            page++;
            groupsContainer = memberV3ApiClient.getGroupIdRecords(100, page, token).getEntity(org.orcid.jaxb.model.v3.release.groupid.GroupIdRecords.class);
        }
        for (Long putCode : putsToDelete) {
            memberV3ApiClient.deleteGroupIdRecord(putCode, token);
        }
        putsToDelete.clear();
    }
    ...
    @Test
    public void testGetGroupIdRecordsWithSeveralFormats_v3_0() throws JSONException, InterruptedException, URISyntaxException, UnsupportedEncodingException {
        String token = oauthHelper.getClientCredentialsAccessToken(this.getClient1ClientId(), this.getClient1ClientSecret(), ScopePathType.GROUP_ID_RECORD_UPDATE);
        
        for(String groupId : VALID_GROUP_IDS) {            
            org.orcid.jaxb.model.v3.release.groupid.GroupIdRecord g1 = new org.orcid.jaxb.model.v3.release.groupid.GroupIdRecord();
            g1.setDescription("Description");
            g1.setGroupId(groupId);
            g1.setName("Group # " + System.currentTimeMillis());
            g1.setType("publisher");
            ClientResponse r1 = memberV3ApiClient.createGroupIdRecord(g1, token);
            String r1LocationPutCode = r1.getLocation().getPath().replace("/orcid-api-web/v3.0/group-id-record/", "");
            ...
            org.orcid.jaxb.model.v3.release.groupid.GroupIdRecord groupFromWebPage = JsonUtils.readObjectFromJsonString(groupElementString, org.orcid.jaxb.model.v3.release.groupid.GroupIdRecord.class);
    ...
    public void testCreateAndView() throws JSONException, InterruptedException, URISyntaxException, UnsupportedEncodingException {
        ...
        ClientResponse result = memberV3ApiClient.getGroupIdRecord(putCode, token);
        assertEquals(Response.Status.OK.getStatusCode(), result.getStatus());
        org.orcid.jaxb.model.v3.release.groupid.GroupIdRecord v3_0 = result.getEntity(org.orcid.jaxb.model.v3.release.groupid.GroupIdRecord.class);
        assertEquals(putCode, v3_0.getPutCode());
        assertEquals("publisher", v3_0.getType());
        assertEquals("Description", v3_0.getDescription());
        assertEquals(groupId, v3_0.getGroupId());
        assertEquals(groupId, v3_0.getName());
        assertNotNull(v3_0.getSource());
        assertEquals(this.getClient1ClientId(), v3_0.retrieveSourcePath());
    }   
}
