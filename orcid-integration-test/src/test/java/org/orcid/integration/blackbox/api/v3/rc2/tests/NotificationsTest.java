...
public class NotificationsTest {
    ...
    @Resource(name = "notificationsClient_v3_0_rc2")
    private NotificationsApiClientImpl<org.orcid.jaxb.model.v3.rc2.notification.permission.NotificationPermission> notificationsClient_V3_0_rc2;
    ...
    public void createPermissionNotification() throws JSONException {
        NotificationPermission notification = unmarshallFromPath("/notification_3.0_rc2/samples/notification-permission-3.0_rc2.xml");
        notification.setPutCode(null);
        String accessToken = oauthHelper.getClientCredentialsAccessToken(client1ClientId, client1ClientSecret, ScopePathType.PREMIUM_NOTIFICATION);

        ClientResponse response = notificationsClient_V3_0_rc2.addPermissionNotificationXml(testUser1OrcidId, notification, accessToken);
        assertNotNull(response);
        assertEquals(Response.Status.CREATED.getStatusCode(), response.getStatus());
        String locationPath = response.getLocation().getPath();
        assertTrue("Location header path should match pattern, but was " + locationPath,
                locationPath.matches(".*/v3.0_rc2/" + testUser1OrcidId + "/notification-permission/\\d+"));
    }
    ...
    public void flagAsArchived() throws JSONException {
        ...
        ClientResponse postResponse = notificationsClient_V3_0_rc2.addPermissionNotificationXml(testUser1OrcidId, notification, accessToken);
        ...
        ClientResponse viewResponse = notificationsClient_V3_0_rc2.viewPermissionNotificationXml(testUser1OrcidId, putCode, accessToken);
        ...
        ClientResponse archiveResponse = notificationsClient_V3_0_rc2.flagAsArchivedPermissionNotificationXml(testUser1OrcidId, putCode, accessToken);
        assertEquals(Response.Status.OK.getStatusCode(), archiveResponse.getStatus());

        ClientResponse viewAfterArchiveResponse = notificationsClient_V3_0_rc2.viewPermissionNotificationXml(testUser1OrcidId, putCode, accessToken);
