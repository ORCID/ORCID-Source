  ...
  popupDialog = $(
    [
      ...
      '<div class="api-popup-content">',
        '<p>Scopes are used to grant an application different levels of access to data on behalf of the end user.</p>',
        '<br/><p><strong>' + appName + '</strong> API requires the following <a href="https://members.orcid.org/api/oauth/orcid-scopes">scopes</a>. Select which ones you want to grant to Swagger UI.</p>',
