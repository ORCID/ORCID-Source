...
@Component({
  selector: "move-client-confirm-ng2",
  template: scriptTmpl("move-client-confirm-ng2-template")
})
export class MoveClientConfirmComponent
  ...
  confirmConvertClient() {
    this.adminActionsService.moveClient(this.clientConversionData).subscribe(
      response => {
