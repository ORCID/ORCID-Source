...
require("./app/main.ts");
require("../XSRF.js");
requireAll(require.context("./app/directives", true, /^(?!.*\.deprecated\.ts$).*\.ts$/));
requireAll(require.context("./app/modules", true, /^(?!.*\.deprecated\.ts$).*\.ts$/));
requireAll(require.context("./app/pipes", true, /^(?!.*\.deprecated\.ts$).*\.ts$/));
requireAll(require.context("./app/shared", true, /^(?!.*\.deprecated\.ts$).*\.ts$/));
