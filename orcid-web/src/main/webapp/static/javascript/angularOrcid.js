...
orcidNgModule.controller('ExternalIdentifierCtrl', ['$scope', '$compile', function ($scope, $compile){
    ...
    $scope.deleteExternalIdentifier = function(idx) {
        ...
        $scope.removeExternalModalText = $scope.externalIdentifiersPojo.externalIdentifiers[idx].externalIdReference;                        
        if ($scope.externalIdentifiersPojo.externalIdentifiers[idx].commonName != null)
            $scope.removeExternalModalText = $scope.externalIdentifiersPojo.externalIdentifiers[idx].commonName.content + ' ' + $scope.removeExternalModalText;
        $.colorbox({
