...
public class FundingsController extends BaseWorkspaceController {
            ...
            for (Funding funding : fundings.getFundings()) {
                try {
                    ...
                    if(!PojoUtil.isEmpty(profileFunding.getExternalIdentifiersJson())) {
                        ...
                        org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifiers fundingExternalIdentifiers = extIdsPojo.toRecordPojo();
    ...
    private void enhanceExternalIdentifiers(ProfileFundingEntity profileFunding, FundingForm funding) {
        if(funding != null && funding.getExternalIdentifiers() != null && !funding.getExternalIdentifiers().isEmpty()) {
            org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifiers extIds = new org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifiers();
            for(FundingExternalIdentifierForm extIdForm : funding.getExternalIdentifiers()) {
                org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifier extId = extIdForm.toRecordFundingExternalIdentifier();
     ...
     * */
    private void enhanceExternalIdentifiers(FundingForm funding, org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifiers extIds) {
