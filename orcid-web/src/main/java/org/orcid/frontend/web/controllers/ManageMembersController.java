...
public class ManageMembersController extends BaseController {
    ...
    public @ResponseBody Group getMember(@RequestParam("orcid") String orcid) {
        Group group = new Group();
    ...
    /**
     * Create a member
     * @param the member to be created
     * @return the member with the orcid information or with the error information
     * */
    ...
    public @ResponseBody Group updateMember(@RequestBody Group group) {
        group.setErrors(new ArrayList<String>());
