...
public class OauthController {
    ...
    public @ResponseBody RequestInfoForm loginGetHandler(HttpServletRequest request, Map<String, Object> model, @RequestParam Map<String, String> requestParameters,
        ...
        if (requestInfoForm.getError() != null || requestInfoForm.getResponseType() != null && !"".equals(requestInfoForm.getResponseType()) && requestInfoForm.getRedirectUrl().contains(requestInfoForm.getResponseType())) {           
