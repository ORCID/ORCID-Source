    ...
    <td colspan="2" ng-show="showEditEmail || emailSrvc.popUp" ng-class="{'email-pop-up' : emailSrvc.popUp}" ng-cloak>
        <div class="editTablePadCell35" ng-controller="EmailEditCtrl" style="position: static">
            ...
            <div ng-show="emailSrvc.popUp && showUnverifiedEmailSetPrimaryBox" class="grey-box">
                ...
                <p><@orcid.msg 'workspace.ensure_future_access3' /> <a  href="${knowledgeBaseUri}/articles/149457"><@orcid.msg 'workspace.ensure_future_access4' /></a> <@orcid.msg 'workspace.ensure_future_access5' /> <a  href="mailto:<@orcid.msg 'workspace.link.email.support' />"><@orcid.msg 'workspace.link.email.support' /></a>.</p>
                <div class="topBuffer">
            ...
            <div class="row bottom-row" ng-hide="isPassConfReq" ng-cloak>
                ...
                <div class="col-md-12">
                    <p style="line-height: 12px;">
                        <small class="italic">
                        ${springMacroRequestContext.getMessage("manage.verificationEmail.1")} <a href="${aboutUri}/content/orcid-terms-use" >${springMacroRequestContext.getMessage("manage.verificationEmail.2")}</a>${springMacroRequestContext.getMessage("manage.verificationEmail.3")}
                        </small>
                    </p>
                </div>              
            </div>
            ...
            <div ng-controller="EmailFrequencyCtrl" ng-cloak>
                ...
                <div class="control-group">
                    <p>${springMacroRequestContext.getMessage("manage.send_email_to_primary_1")} <a href="${baseUri}/inbox" >${springMacroRequestContext.getMessage("manage.send_email_to_primary_2")}</a>${springMacroRequestContext.getMessage("manage.send_email_to_primary_3")}</p>
