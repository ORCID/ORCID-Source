<script type="text/ng-template" id="link-account-ng2-template">
    ...
    <div *ngIf="shibbolethSignin || socialSignin"> 
        <div *ngIf="signinData && signinData.unsupportedInstitution" class="col-md-9 col-sm-9 col-sm-push-3 col-md-push-3">
            ...
            <p>${springMacroRequestContext.getMessage("social.link.unsupported.we_have_made_a_note.1")}<a href="mailto:{{signinData.institutionContactEmail}}?subject=${springMacroRequestContext.getMessage("social.link.unsupported.email.subject")?url}&amp;body=${springMacroRequestContext.getMessage("social.link.unsupported.email.body")?url}">${springMacroRequestContext.getMessage("social.link.unsupported.we_have_made_a_note.2")}</a>${springMacroRequestContext.getMessage("social.link.unsupported.we_have_made_a_note.3")}<a href="{{getBaseUri()}}/signin">${springMacroRequestContext.getMessage("social.link.unsupported.we_have_made_a_note.4")}</a>${springMacroRequestContext.getMessage("social.link.unsupported.we_have_made_a_note.5")}</p>
            <p class="see-more">
