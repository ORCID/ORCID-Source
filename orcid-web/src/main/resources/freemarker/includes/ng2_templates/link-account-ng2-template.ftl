<script type="text/ng-template" id="link-account-ng2-template">
    ...
    <div *ngIf="shibbolethSignin || socialSignin"> 
        ...
        <form class="form-social-sign-in shibboleth" id="loginForm" *ngIf="signinData && !signinData.unsupportedInstitution && !signinData.unsupportedInstitution && loadedFeed" action="<@orcid.rootPath '/shibboleth/signin/auth'/>" method="post">
            <div class="row">
