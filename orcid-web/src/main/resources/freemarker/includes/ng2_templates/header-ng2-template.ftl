                ...
                <ul class="menu" *ngIf="menuVisible == true"  resize>
                    ...
                    <li class="expanded">
                        ...
                        <ul class="menu lang-fixes">
                            ...
                            <li class="leaf">
                                <a href="https://zendesk.orcid.org/hc/en-us" title=""><@orcid.msg 'public-layout.give_feedback'/></a>
                            </li>
                            <li class="last leaf">
                                <a href="https://zendesk.orcid.org/hc/en-us/community/topics" title=""><@orcid.msg 'public-layout.knowledge_base'/></a>
                            </li>
                        </ul>
                    </li>
