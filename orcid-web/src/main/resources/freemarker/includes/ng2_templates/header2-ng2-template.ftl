                        ...
                        <div class="input-group" role="presentation">
                            <div class="input-group-addon"   (click)="clickDropdown()"  (keyup.enter)="clickDropdown()"  tabindex="0" >
                                <div role="presentation" class="search-dropdown" [ngClass]="{'hover': searchDropdownOpen}"  (mouseleave)="closeDropdown()">
                                    <div aria-haspopup="listbox"  [attr.aria-expanded]="searchDropdownOpen" aria-label="'${springMacroRequestContext.getMessage("aria.search-location")?replace("<br />", " ")?replace("'", "\\'")}" class="search-dropbtn"  > {{ (headerSearch.searchOption === 'website'? '${springMacroRequestContext.getMessage("layout.public-layout.website")?replace("<br />", " ")?replace("'", "\\'")}':'${springMacroRequestContext.getMessage("layout.public-layout.registry")?replace("<br />", " ")?replace("'", "\\'")}') | titlecase }} <span [ngClass]="{'dropdown-arrow': !searchDropdownOpen, 'dropdown-arrow-up': searchDropdownOpen}"></span> </div>
                                    <ul class="dropdown-content" role="listbox" aria-label="where to search">
                                        <div  tabindex="0" role="option"  (keyup.enter)="clickDropdown('registry')" (click)="clickDropdown('registry')"> {{'${springMacroRequestContext.getMessage("layout.public-layout.registry")?replace("<br />", " ")?replace("'", "\\'")}'| titlecase }} </div>
                                        <div tabindex="0"  role="option"  (keyup.enter)="clickDropdown('website')" (click)="clickDropdown('website')"> {{'${springMacroRequestContext.getMessage("layout.public-layout.website")?replace("<br />", " ")?replace("'", "\\'")}'| titlecase  }} </div>
                                    </ul>
                                </div>  
                            </div>
        ...
        <div class="menu-bar"  [hidden]="!openMobileMenu && isMobile"  (mouseleave)="mouseLeave()" role="navigation" aria-label="main menu">
                ...
                <ul class="menu" resize  role="presentation" role="menu">
                    ...
                    <li class="first expanded" role="presentation"
                     [ngClass]="{'hover': mobileMenu.RESEARCHERS, 'open':  this.currentUrl.indexOf('signin') == -1}"  >
                        ...
                        <ul class="menu lang-fixes" *ngIf="!userInfo['REAL_USER_ORCID']" aria-label="submenu">
                            ...
                            <!-- Menu -->
                            <li class="leaf last"><a ${(nav=="signin")?then('class="active" ', '')} href="{{getBaseUri()}}/signin" role="menuitem">{{'${springMacroRequestContext.getMessage("public-layout.sign_in")?replace("<br />", " ")?replace("'", "\\'")} '| uppercase }}</a></li>                                   
                            <li class="leaf last"><a ${(nav=="register")?then('class="active" ', '')} href="{{getBaseUri()}}/register" role="menuitem">{{'${springMacroRequestContext.getMessage("public-layout.register")?replace("<br />", " ")?replace("'", "\\'")} '| uppercase }}</a></li>                                                                                                                          
                            <li class="leaf last"><a href="{{getBaseUri()}}/content/initiative" role="menuitem">{{'${springMacroRequestContext.getMessage("manage_delegators.learn_more.link.text")?replace("<br />", " ")?replace("'", "\\'")} '| uppercase }}</a></li>
                        </ul>
                        <ul class="menu lang-fixes" *ngIf="userInfo['REAL_USER_ORCID']"  aria-label="submenu">
                            <li role="presentation" >
                                <a ${(nav=="record")?then('class="active" ', '')}href="{{getBaseUri()}}/my-orcid" role="menuitem" aria-labelby="my-orcid-menu-item">
                                    <div *ngIf="userInfo['IN_DELEGATION_MODE'] == 'true'" role="menuitem" id="my-orcid-menu-item">
                            ...
                            <li role="presentation">
                                {{retrieveUnreadCount()}}
                                <a role="menuitem" ${(nav=="notifications")?then('class="active" ', '')} href="{{getBaseUri()}}/inbox">{{'${springMacroRequestContext.getMessage("workspace.notifications")}  '| uppercase }} <span *ngIf="getUnreadCount > 0">({{getUnreadCount}})</span></a>
                            </li>
                            <li role="presentation">
                            ...
                            <!-- Developer tools -->
                            <li role="presentation" *ngIf="(userInfo['IN_DELEGATION_MODE'] == 'false' || userInfo['DELEGATED_BY_ADMIN'] == 'true') && userInfo['MEMBER_MENU']=='true'"><a role="menuitem" ${(nav=="developer-tools")?then('class="active" ', '')}href="{{getBaseUri()}}/group/developer-tools">{{'${springMacroRequestContext.getMessage("workspace.developer_tools")}'| uppercase }}</a></li>
                            <li *ngIf="(userInfo['IN_DELEGATION_MODE'] == 'false' || userInfo['DELEGATED_BY_ADMIN'] == 'true') && userInfo['MEMBER_MENU']!='true'"><a role="menuitem" ${(nav=="developer-tools")?then('class="active" ', '')}href="{{getBaseUri()}}/developer-tools">{{'${springMacroRequestContext.getMessage("workspace.developer_tools")}'| uppercase }}</a></li>
                            
                            <!-- Admin menu -->
                            <li  role="presentation" role="presentation" *ngIf="userInfo['ADMIN_MENU']"><a role="menuitem" ${(nav=="members")?then('class="active" ', '')}href="{{getBaseUri()}}/manage-members">{{'${springMacroRequestContext.getMessage("admin.members.workspace_link")?replace("<br />", " ")?replace("'", "\\'")}  '| uppercase }}</a></li>
                            <li  role="presentation" *ngIf="userInfo['ADMIN_MENU']"><a  role="menuitem" ${(nav=="admin")?then('class="active" ', '')}href="{{getBaseUri()}}/admin-actions">{{'${springMacroRequestContext.getMessage("admin.workspace_link")?replace("<br />", " ")?replace("'", "\\'")}  '| uppercase }}</a></li>
                                
                            <!-- Self service menu -->
                            <li  role="presentation" *ngIf="userInfo['SELF_SERVICE_MENU']"><a role="menuitem" ${(nav=="self-service")?then('class="active" ', '')}href="{{getBaseUri()}}/self-service">{{'${springMacroRequestContext.getMessage("workspace.self_service")?replace("<br />", " ")?replace("'", "\\'")}  '| uppercase }}</a></li>
                    ...
                    <li role="presentation" class="expanded" [ngClass]="{'hover': mobileMenu.ORGANIZATIONS}" >
                        <a href="{{aboutUri}}/organizations" role="menuitem" (mouseenter)="menuHandler('ORGANIZATIONS', $event)" (focus)="menuHandler('ORGANIZATIONS', $event)" (click)="menuHandler('ORGANIZATIONS', $event)">{{'${springMacroRequestContext.getMessage("public-layout.for_organizations")?replace("<br />", " ")?replace("'", "\\'")}  '| uppercase }}<span class="more" [ngClass]="{'less':mobileMenu.ORGANIZATIONS == true}"></span></a>
                        <ul class="menu lang-fixes"  aria-label="submenu">
                            <!-- Mobile view Only -->
                            <li role="presentation" class="first leaf" [hidden]="!isMobile" >
                                <a role="menuitem" href="{{aboutUri}}/organizations" >{{'${springMacroRequestContext.getMessage("public-layout.for_organizations")?replace("<br />", " ")?replace("'", "\\'")}  '| uppercase }}</a>
                            </li>

                            <li role="presentation" class="first leaf">
                                <a role="menuitem" href="{{aboutUri}}/organizations/funders" (click)="handleMobileMenuOption($event); toggleSecondaryMenu('funders')" class="russian-fix" >{{'${springMacroRequestContext.getMessage("public-layout.funders")?replace("<br />", " ")?replace("'", "\\'")}'| uppercase }}<span class="more" [ngClass]="{'less':secondaryMenuVisible['funders'] == true}"></span></a> <!-- Updated according Drupal website structure -->
                            ...
                            <li role="presentation" class="leaf">
                                <a role="menuitem" href="{{aboutUri}}/organizations/publishers" (click)="handleMobileMenuOption($event); toggleSecondaryMenu('publishers')">{{'${springMacroRequestContext.getMessage("public-layout.publishers")?replace("<br />", " ")?replace("'", "\\'")} '| uppercase }}<span class="more" [ngClass]="{'less':secondaryMenuVisible['publishers'] == true}"></span></a> <!-- Updated according Drupal website structure -->
                            ...
                            <li role="presentation" class="last leaf">
                                <a role="menuitem" href="{{aboutUri}}/organizations/integrators" (click)="handleMobileMenuOption($event); toggleSecondaryMenu('integrators')">{{'${springMacroRequestContext.getMessage("public-layout.integrators")?replace("<br />", " ")?replace("'", "\\'")}'| uppercase }} <span class="more" [ngClass]="{'less':secondaryMenuVisible['integrators'] == true}"></span></a> <!-- Updated according Drupal website structure -->
                    ...
                    <li role="presentation" class="expanded" [ngClass]="{'hover': mobileMenu.ABOUT}"  >
                        <a href="{{aboutUri}}/about" role="menuitem" (mouseenter)="menuHandler('ABOUT', $event)" (focus)="menuHandler('ABOUT', $event)" (click)="menuHandler('ABOUT', $event)">{{'${springMacroRequestContext.getMessage("public-layout.about")?replace("<br />", " ")?replace("'", "\\'")} '| uppercase }} <span class="more" [ngClass]="{'less':mobileMenu.ABOUT == true}"></span></a>

                        <ul class="menu lang-fixes"  aria-label="submenu">
                            <!-- Mobile view Only -->
                            <li  role="presentation" [hidden]="!isMobile" ><a role="menuitem" href="{{aboutUri}}/about"
                            ...
                            <li role="presentation" class="first expanded">
                                <a role="menuitem" href="{{aboutUri}}/about/what-is-orcid" (click)="handleMobileMenuOption($event); toggleSecondaryMenu('whatIsOrcid')">{{'${springMacroRequestContext.getMessage("public-layout.what_is_orcid")?replace("<br />", " ")?replace("'", "\\'")} '| uppercase }} <span class="more" [ngClass]="{'less':secondaryMenuVisible['whatIsOrcid'] == true}"></span></a>
                            ...
                            <!-- The ORCID Team -->
                            <li role="presentation" class="leaf"><a role="menuitem" href="{{aboutUri}}/about/team" title="">{{'${springMacroRequestContext.getMessage("public-layout.the_orcid_team")?replace("<br />", " ")?replace("'", "\\'")}  '| uppercase }}</a></li>
                            <!-- The ORCID Comunity -->
                            <li role="presentation" class="expanded" >
                                <a role="menuitem" href="{{aboutUri}}/about/community" (click)="handleMobileMenuOption($event); toggleSecondaryMenu('community')">{{'${springMacroRequestContext.getMessage("public-layout.the_orcid_community")?replace("<br />", " ")?replace("'", "\\'")} '| uppercase }} <span class="more" [ngClass]="{'less':secondaryMenuVisible['community'] == true}"></span></a>
                            ...
                            <!-- Membership -->
                            <li role="presentation" class="expanded" >
                                <a role="menuitem" href="{{aboutUri}}/about/membership" (click)="handleMobileMenuOption($event); toggleSecondaryMenu('membership')"    >{{'${springMacroRequestContext.getMessage("public-layout.membership")?replace("<br />", " ")?replace("'", "\\'")} '| uppercase }} <span class="more" [ngClass]="{'less':secondaryMenuVisible['membership'] == true}"></span></a>
                            ...
                            <!-- News -->
                            <li role="presentation" class="leaf">
                                <a role="menuitem" href="{{aboutUri}}/about/news/news" (click)="handleMobileMenuOption($event); toggleSecondaryMenu('news')">{{'${springMacroRequestContext.getMessage("public-layout.news")?replace("<br />", " ")?replace("'", "\\'")}  '| uppercase }}<span class="more" [ngClass]="{'less':secondaryMenuVisible['news'] == true}"></span></a>
                            ...
                            <li role="presentation" class="last expanded">
                                <a role="menuitem" href="{{aboutUri}}/about/events" title="">{{'${springMacroRequestContext.getMessage("public-layout.events")?replace("<br />", " ")?replace("'", "\\'")}  '| uppercase }}</a>
                            </li>
                        </ul>
                    </li>
                    <!-- HELP -->
                    <li role="presentation" class="expanded" [ngClass]="{'hover': mobileMenu.HELP}"  >
                        <a role="menuitem" href="{{aboutUri}}/help" (mouseenter)="menuHandler('HELP', $event)" (focus)="menuHandler('HELP', $event)" (click)="menuHandler('HELP', $event)">{{'${springMacroRequestContext.getMessage("public-layout.help")?replace("<br />", " ")?replace("'", "\\'")}   '| uppercase }}<span class="more" [ngClass]="{'less':mobileMenu.HELP == true}"></span></a>
                        <ul  [hidden]="!isMobile" class="menu lang-fixes"  aria-label="submenu">
                            <!-- Mobile view Only -->
                            <li role="presentation" class="first leaf    "  [hidden]="!isMobile">
                                <a role="menuitem" href="{{aboutUri}}/help">{{'${springMacroRequestContext.getMessage("public-layout.help")?replace("<br />", " ")?replace("'", "\\'")}  '| uppercase }}</a>
                            </li>
                            <li role="presentation" class="first leaf">
