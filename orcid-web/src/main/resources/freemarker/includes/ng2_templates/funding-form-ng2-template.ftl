        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="deactivateAccountMessage-group">
                    ...
                    <select id="fundingType" class="deactivateAccountMessage-control" name="fundingType" [(ngModel)]="editFunding.fundingType.value" (onChange)="serverValidate('fundings/funding/typeValidate.json'); typeChanged()">
                ...
                <div class="deactivateAccountMessage-group">
                    ...
                    <input id="fundingTitle" class="deactivateAccountMessage-control" name="fundingTitle" type="text" [(ngModel)]="editFunding.fundingTitle.title.value" placeholder="<@orcid.msg 'manual_funding_form_contents.add_title'/>" (onChange)="serverValidate('fundings/funding/titleValidate.json')" />
                ...
                <div class="deactivateAccountMessage-group">
                    ...
                    <div class="relative">
                        <textarea id="fundingDescription" class="deactivateAccountMessage-control" name="fundingDescription" type="text" [(ngModel)]="editFunding.description.value" placeholder="<@orcid.msg 'manual_funding_form_contents.add_description'/>" (onChange)="serverValidate('fundings/funding/descriptionValidate.json')"></textarea>
                ...
                <div class="deactivateAccountMessage-group">
                    ...
                    <div class="funding-info">
                        ...
                        <input id="fundingAmount" name="fundingAmount" type="text" [(ngModel)]="editFunding.amount.value" placeholder="<@orcid.msg 'manual_funding_form_contents.add_amount'/>" (onChange)="serverValidate('fundings/funding/amountValidate.json')" [ngClass]="deactivateAccountMessage-control" />
                    </div>
                ...
                <div class="deactivateAccountMessage-group" *ngFor="let contributor of editFunding.contributors">
                    <label><@orcid.msg 'manual_funding_form_contents.label_role'/></label>                    
                    <select id="role" name="role" [(ngModel)]="contributor.contributorRole.value" class="deactivateAccountMessage-control">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="deactivateAccountMessage-group">
                    ...
                    <input id="fundingName" class="deactivateAccountMessage-control" name="fundingName" type="text" [(ngModel)]="editFunding.fundingName.value" placeholder="<@orcid.msg 'manual_funding_form_contents.add_name'/>" (onChange)="serverValidate('fundings/funding/orgNameValidate.json')" />
                ...
                <div class="deactivateAccountMessage-group">
                    ...
                    <input id="city" name="city" type="text" class="deactivateAccountMessage-control"  [(ngModel)]="editFunding.city.value" placeholder="<@orcid.msg 'manual_funding_form_contents.add_city'/>" (onChange)="serverValidate('fundings/funding/cityValidate.json')" />                        
                ...
                <div class="deactivateAccountMessage-group">
                    ...
                    <select id="country" class="deactivateAccountMessage-control" name="country" [(ngModel)]="editFunding.country.value" (onChange)="serverValidate('fundings/funding/countryValidate.json')">
                ...
                <div class="control-group" *ngFor="let externalIdentifier of  editFunding.externalIdentifiers">
                    ...
                    <div class="deactivateAccountMessage-group">
                        ...
                        <input name="currentFundingExternalIdentifierUrl" id="funding-ext-ids-url-input" type="text" class="deactivateAccountMessage-control action-icon-inside" [(ngModel)]="externalIdentifier.url.value" placeholder="<@orcid.msg 'manual_funding_form_contents.external_identifier.url'/>" />                        
