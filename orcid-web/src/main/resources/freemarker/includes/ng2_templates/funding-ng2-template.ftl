                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <a href="" (click)="workspaceSrvc.toggleFunding($event)" class="toggle-text">
                            ...
                            <@orcid.msg 'workspace.Funding'/> (<span [innerHTML]="groups.length"></span>)
                        </a>
                        <#if !(isPublicProfile??)> 
                                    ...
                                    <div class="row" *ngIf="group.activePutCode == funding.putCode.value">
                                        <div class="col-md-9 col-sm-9 col-xs-7">
                                            ...
                                            <div class="clear-fix left">
                                                <span *ngIf="group.getActive().fundingName.value"><span [innerHTML]="group.getActive().fundingName.value"></span></span> (<span *ngIf="group.getActive().city.value"><span [innerHTML]="group.getActive().city.value"></span></span><span *ngIf="group.getActive().region.value">, <span [innerHTML]="group.getActive().region.value"></span></span><span *ngIf="group.getActive().countryForDisplay">, <span [innerHTML]="group.getActive().countryForDisplay"></span></span>)
                                            </div>  
                                            <div class="info-detail">
                                                ...
                                                <span class="funding-date" *ngIf="group.getActive().startDate && group.getActive().endDate">
                                                    ...
                                                    <span *ngIf="group.getActive().endDate.year" [innerHTML]="group.getActive().endDate.year"></span><span *ngIf="group.getActive().endDate.month">-</span><span *ngIf="group.getActive().endDate.month" [innerHTML]="group.getActive().endDate.month"></span>
                                                </span>
                                                <span class="funding-date" *ngIf="!group.getActive().startDate && group.getActive().endDate">
                                                     <span *ngIf="group.getActive().endDate.year" [innerHTML]="group.getActive().endDate.year"></span><span *ngIf="group.getActive().endDate.month">-</span><span *ngIf="group.getActive().endDate.month" [innerHTML]="group.getActive().endDate.month"></span>
                                                </span>                                
                                                <!-- Funding type -->
                                                <span *ngIf="(group.getActive().startDate || group.getActive().endDate) && group.getActive().fundingType.value">|</span> <span [innerHTML]="group.getActive().fundingTypeForDisplay" class="capitalize"></span>
                                            </div>                            
                                        </div>
                                                ...
                                                <div class="bottomBuffer">
                                                    ...
                                                    <div *ngFor="let contributor of group.getActive().contributors">
                                                        {{contributor.creditName.value}} <span
                                                            [innerHTML]='contributor | contributorFilter'></span>
                                                    </div>        
                                                </div>
                                            </div>
