        ...
        <div class="row">
            <div class="col-md-12 col-xs-12 col-sm-12" style="position: static">
                       ...
                       <div class="row aka-row" *ngFor="let otherName of formData.otherNames; let index = index; let first = first; let last = last;" >                                                            
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12" style="position: static">                                                                                                                          
                                <ul class="record-settings pull-right">
                                    ...
                                    <li>
                                        <div class="glyphicon glyphicon-trash delete-other-name" (click)="deleteOtherName(otherName, index)" (mouseenter)="commonSrvc.showTooltip('tooltip-aka-delete-'+index, $event, 37, 50, 39)" (mouseleave)="commonSrvc.hideTooltip('tooltip-aka-delete-'+index)"></div>
                ...
                <div class="record-buttons">
                    <a (click)="addNew()" id="add-other-name"><span class="glyphicon glyphicon-plus pull-left">
