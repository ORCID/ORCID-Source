...
<script type="text/ng-template" id="password-edit-ng2-template">
    ...
    <div class="form-group">
        ...
        <input id="passwordField" type="password" name="oldPassword" (keyup.enter)="saveChangePassword()" 
            [(ngModel)]="changePasswordPojo.oldPassword" class="input-xlarge" />
        <span class="required">*</span>
    </div>
    <div class="form-group">
        <label for="passwordField">${springMacroRequestContext.getMessage("change_password.newpassword")}</label><br>
        <input id="password" type="password" name="password" (keyup.enter)="saveChangePassword()" 
            [(ngModel)]="changePasswordPojo.password" class="input-xlarge" />
    ...
    <div class="form-group">
        ...
        <input id="retypedPassword" type="password"
                ...
                [(ngModel)]="changePasswordPojo.retypedPassword" (keyup.enter)="saveChangePassword()" 
                class="input-xlarge" />
        <span class="required">*</span>
    </div>
