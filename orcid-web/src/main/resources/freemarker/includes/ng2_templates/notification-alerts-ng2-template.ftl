        ...
        <ng-container *ngFor="let notification of  notificationsSrvc.notificationAlerts; let index = index">
            <div class="notification-alert">        
                ...
                <div class="pull-right">
                    ...
                    <a href="<@orcid.rootPath '/inbox'/>/{{notification.putCode}}/action?target={{notification.source.sourceClientId.uri | uri}}" (click)="archive(notification.putCode)" target="notifications.alert_link" class="btn btn-primary"><@orcid.msg 'notifications.alert_link'/></a>
                </div>  
            </div>
        </ng-container>
    </div>
