<script type="text/ng-template" id="move-client-confirm-ng2-template">
    <div class="colorbox-content">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12"> 
                <h1><@orcid.msg 'admin.move_client.confirmation.title'/></h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12"> 
                <p><@orcid.msg 'admin.move_client.confirmation.message'/></p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12"> 
                <div class="control-group">
                    <button (click)="confirmConvertClient()" class="btn btn-primary"><@orcid.msg 'admin.move_client.confirmation.button.label'/></button>&nbsp;
