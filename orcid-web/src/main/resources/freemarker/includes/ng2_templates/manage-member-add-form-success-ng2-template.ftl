		...
		<div class="row" *ngIf="newMember">
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="control-group">
    				...
    				<div class="relative">
      					<span>{{newMember.groupOrcid.value}}&nbsp;(<@orcid.msg 'admin.switch.click.1'/>&nbsp;<a (click)="switchUser(newMember.groupOrcid.value)"><@orcid.msg 'admin.switch.click.here'/></a>&nbsp;<@orcid.msg 'admin.switch.click.2'/>)</span>
    				</div>
  				</div>
