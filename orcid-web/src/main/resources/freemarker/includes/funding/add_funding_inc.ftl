        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <input id="fundingName" class="form-control" name="fundingName" type="text" ng-model="editFunding.fundingName.value" placeholder="<@orcid.msg 'manual_funding_form_contents.add_name'/>" ng-change="clearDisambiguatedOrgAndServerValidate('fundings/funding/orgNameValidate.json')" ng-model-onblur/>
