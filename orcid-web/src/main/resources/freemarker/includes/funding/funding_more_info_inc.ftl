...
-->
<div class="more-info" ng-mouseleave="closeMoreInfo(funding.putCode.value)" ng-class="{'more-info-show':moreInfo[funding.putCode.value]==true}">
		...
		<div class="lightbox-container">
			...
			<div class="row bottomBuffer" ng-show="funding.organizationDefinedFundingType.value"
				...
				<div class="col-md-8">					
					...
					<div ng-bind="funding.organizationDefinedFundingType.value"></div>
				</div>
			</div>
