                      ...
                      <div class="row source-line" ng-if="group.activePutCode == work.putCode.value">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-10" ng-if="editSources[group.groupId]">
                            ...
                            <div ng-if="editSources[group.groupId]">
                                ...
                                <#if !(isPublicProfile??)>
                                    <a ng-click="worksSrvc.makeDefault(group, work.putCode.value, sortState.predicateKey, !sortState.reverseKey[sortState.predicateKey]); " ng-if="work.putCode.value != group.defaultWork.putCode.value">
