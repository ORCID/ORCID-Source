					...
					<ul class="sources-options" ng-cloak>
				        ...
				        <li class="show-more-info-tab-container">
					        <span class="show-more-info-tab work-tab">			
								<a href="" ng-show="!moreInfo[group.groupId]" ng-click="showDetailsMouseClick(group,$event);"><span class="glyphicon glyphicon-chevron-down"></span><@orcid.msg 'common.details.show_details'/></a>									
								<a href="" ng-show="moreInfo[group.groupId]" ng-click="showDetailsMouseClick(group,$event);"><span class="glyphicon glyphicon-chevron-up"></span><@orcid.msg 'common.details.hide_details'/></a>
							</span>							
				        </li>                               
				    </ul>
				</div>
