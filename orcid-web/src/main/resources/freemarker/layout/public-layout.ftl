                ...
                <div class="alignment clearfix">
                    ...
                    <nav class="main">
                        <ul class="menu"><li class="first expanded active-trail"><a href="<@spring.url "/" />" title=""><@orcid.msg 'public-layout.for_researchers'/></a><ul class="menu">
                            <@security.authorize ifNotGranted="ROLE_USER, ROLE_BASIC, ROLE_PREMIUM, ROLE_INSTITUTION, ROLE_PREMIUM_INSTITUTION">
                            ...
                            <@security.authorize ifAnyGranted="ROLE_USER, ROLE_BASIC, ROLE_PREMIUM, ROLE_INSTITUTION, ROLE_PREMIUM_INSTITUTION">
						...
						<li class="last leaf">
						    <@security.authorize ifNotGranted="ROLE_USER, ROLE_BASIC, ROLE_PREMIUM, ROLE_INSTITUTION, ROLE_PREMIUM_INSTITUTION"><a href="<@spring.url "/signin" />" title=""><@orcid.msg 'public-layout.sign_in'/></a></@security.authorize>
						    <@security.authorize ifAnyGranted="ROLE_USER, ROLE_BASIC, ROLE_PREMIUM, ROLE_INSTITUTION, ROLE_PREMIUM_INSTITUTION"><a href="<@spring.url '/signout'/>"><@orcid.msg 'public-layout.sign_out'/></a></@security.authorize>
						</li>
					</ul>
				</nav>
