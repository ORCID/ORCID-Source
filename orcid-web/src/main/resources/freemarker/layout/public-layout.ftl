		...
		<div class="row">
			<div class="col-md-9 col-sm-9 col-sm-push-3 col-md-push-3 navigation" ng-controller="menuCtrl">
				...
				<ul class="menu" ng-show="active == true" ng-cloak>
					...
					<!-- FOR ORGANIZATIONS -->
					<li class="expanded"><a href="${aboutUri}/organizations"><@orcid.msg
							'public-layout.for_organizations'/></a>
						<ul class="menu lang-fixes">
							<!-- Mobile view Only -->
							<li class="first leaf hidden-md hidden-lg hidden-sm visible-xs"><a
								href="${aboutUri}/organizations"><@orcid.msg
									'public-layout.for_organizations'/></a></li>

							<li class="first leaf"><a
								href="${aboutUri}/organizations/funders" class="russian-fix"><@orcid.msg
								...
								<ul class="menu">
									<li class="first leaf"><a
										href="${aboutUri}/organizations/funders/learnmore">Learn
											more</a></li>
									<li class="leaf"><a
										href="${aboutUri}/organizations/funders/outreachresources">Outreach
											Resources</a></li>
									<li class="last leaf"><a
										href="${aboutUri}/about/membership" title="">Membership</a></li>
								</ul></li>

							<li class="leaf"><a
								href="${aboutUri}/organizations/institutions" title="">
								...
								<ul class="menu">
									<li class="first leaf"><a
										href="${aboutUri}/organizations/institutions/learnmore">Learn
											more</a></li>
									<li class="leaf"><a
										href="${aboutUri}/organizations/institutions/outreachresources">Outreach
											Resources</a></li>
									<li class="leaf"><a href="${aboutUri}/about/membership"
										title="">Membership</a></li>
									<li class="last leaf"><a
										href="${aboutUri}/organizations/institutions/usecases">Use
											cases</a></li>
								</ul></li>
							<li class="leaf"><a
								href="${aboutUri}/organizations/publishers"> <@orcid.msg
								...
								<ul class="menu">
									<li class="first leaf"><a
										href="${aboutUri}/organizations/publishers/learnmore">Learn
											more</a></li>
									<li class="leaf"><a
										href="${aboutUri}/organizations/publishers/outreachresources">Outreach
											Resources</a></li>
									<li class="last leaf"><a
										href="${aboutUri}/about/membership" title="">Membership</a></li>
								</ul></li>
							<li class="leaf"><a
								href="${aboutUri}/organizations/associations" title=""><@orcid.msg
								...
								<ul class="menu">
									...
									<li class="leaf"><a
										href="/organizations/associations/outreachresources">Outreach
											resources</a></li>
									<li class="leaf"><a
										href="http://orcid.org/about/membership" title="">Membership</a></li>
									<li class="last leaf"><a
										href="/organizations/associations/usecases" title="">Use
											cases</a></li>
								</ul></li>
							<li class="last leaf"><a
								href="${aboutUri}/organizations/integrators"><@orcid.msg
								...
								<ul class="menu">
									<li class="first leaf"><a
										href="${aboutUri}/organizations/integrators/API">The ORCID
											API</a></li>
									<li class="leaf"><a
										href="${aboutUri}/content/register-client-application-0">Register
											a Client Application</a></li>
									<li class="leaf"><a
										href="${aboutUri}/organizations/integrators/current">Current
											Integrations</a></li>
									<li class="leaf"><a
										href="${aboutUri}/organizations/integrators/integration-chart">Integration
											Chart</a></li>
									<li class="last leaf"><a
										href="${aboutUri}/content/beta-tester-request">Beta
											Testers</a></li>
								</ul></li>
						</ul></li>

					<!-- ABOUT -->
					<li class="expanded"><a href="${aboutUri}/about"><@orcid.msg
						...
						<ul class="menu lang-fixes">
							...
							<li class="first expanded"><a
								href="${aboutUri}/about/what-is-orcid" title=""><@orcid.msg
									'public-layout.what_is_orcid'/></a>
								<ul class="menu">
									<li class="first leaf"><a
										href="${aboutUri}/about/what-is-orcid/mission-statement"
										title=""><@orcid.msg 'public-layout.our_mission'/></a></li>
									<li class="leaf"><a
										href="${aboutUri}/about/what-is-orcid/our-principles" title=""><@orcid.msg
											'public-layout.our_principles'/></a></li>
									<li class="leaf"><a
										href="${aboutUri}/content/our-governance">Our Governance</a></li>
									<li class="last expanded"><a
										href="${aboutUri}/about/what-is-orcid/policies">Our
											Policies</a>
										<ul class="menu">
											<li class="first leaf"><a
							...
							<!-- The ORCID Comunity -->
							<li class="expanded"><a href="${aboutUri}/about/community"
								title=""><@orcid.msg 'public-layout.the_orcid_community'/></a>
								<ul class="menu">
									<li class="first leaf"><a
									...
									<li class="leaf"><a
										href="${aboutUri}/about/community/members" title=""><@orcid.msg
											'public-layout.members'/></a></li>
									<li class="last"><a
										href="${aboutUri}/about/community/launch-partners" title=""><@orcid.msg
											'public-layout.launch_partners'/></a></li>
									<li class="leaf"><a
										href="${aboutUri}/about/community/launch-partners" title="">Launch
											Partners</a></li>
									<li class="leaf"><a
										href="${aboutUri}/about/community/orcid-technical-community">Open
											Source</a></li>
									<li class="leaf"><a href="${aboutUri}/content/partners">Partners</a></li>
									<li class="leaf"><a
										href="${aboutUri}/content/adoption-and-integration-program">Adoption
											&amp; Integration Program</a></li>
									<li class="expanded"><a
										href="${aboutUri}/content/orcid-ambassadors">Ambassadors</a>
										<ul class="menu">
											<li class="first last leaf"><a
												href="${aboutUri}/content/orcid-ambassadors-1/outreachresources">Outreach
													Resources</a></li>
										</ul></li>
									<li class="last leaf"><a
										href="http://www.cafepress.com/orcid" title="">ORCID Gear</a></li>
								</ul>
								...
								<ul class="menu">
									<li class="first leaf"><a
										href="${aboutUri}/about/community" title="" class="active">ORCID
											Community</a></li>
									<li class="leaf"><a
										href="${aboutUri}/about/community/sponsors">Sponsors</a></li>
									<li class="leaf"><a href=${aboutUri}"/about/community/members">Members</a></li>


								</ul></li>
							<!-- Membership -->
							<li class="expanded"><a href="${aboutUri}/about/membership"
								title=""><@orcid.msg 'public-layout.membership'/></a>
								<ul class="menu">
									<li class="first expanded"><a
										href="${aboutUri}/about/membership" title=""><@orcid.msg
											'public-layout.membership_and_subscription'/></a>
										<ul class="menu">
											<li class="first last leaf"><a
												href="${aboutUri}/content/membership-comparison">Membership
													Comparison</a></li>
										</ul></li>
									<li class="leaf"><a
										href="${aboutUri}/about/membership/standard-member-agreement"
										title=""><@orcid.msg
											'public-layout.standard_member_agreement'/></a></li>
									<li class="leaf"><a
										href="${aboutUri}/document/standard-creator-membership-agreement">Standard
											Creator Member Agreement</a></li>
									<li class="last leaf"><a
										href="${aboutUri}/about/community/members" title=""><@orcid.msg
											'public-layout.our_members'/></a></li>
								</ul></li>

							<!-- News -->
							<li class="leaf"><a href="${aboutUri}/about/news/news"
								title=""><@orcid.msg 'public-layout.news'/>
									<ul class="menu">
										<li class="first leaf"><a
											href="${aboutUri}/category/newsletter/blog" title="">Blog</a></li>
										<li class="last leaf"><a
											href="${aboutUri}/newsletter/subscriptions" title="">Subscribe!</a></li>
									</ul>
							</a> <!-- Events -->
							<li class="last expanded"><a href="${aboutUri}/about/events"
								title=""><@orcid.msg 'public-layout.events'/></a> <!-- 
								<ul class="menu">
					...
					<!-- HELP -->
					<li class="expanded"><a href="${aboutUri}/help"><@orcid.msg
							'public-layout.help'/></a>
						<ul class="menu lang-fixes">
							<!-- Mobile view Only -->
							<li class="first leaf hidden-md hidden-lg hidden-sm visible-xs"><a
								href="${aboutUri}/help"><@orcid.msg 'public-layout.help'/></a></li>

							<li class="first leaf"><a href="${aboutUri}/faq-page"
								title=""><@orcid.msg 'public-layout.faq'/></a></li>
							<li class="leaf"><a href="${aboutUri}/help/contact-us"
								title=""><@orcid.msg 'public-layout.contact_us'/></a></li>
							<li class="leaf"><a
								href="http://orcid.uservoice.com/forums/175591-general" title=""><@orcid.msg
									'public-layout.give_feedback'/></a></li>
							<li class="last leaf"><a
								href="http://orcid.uservoice.com/knowledgebase" title=""><@orcid.msg
									'public-layout.knowledge_base'/></a></li>
						</ul></li>
					<!-- END OF DRUPAL WEBSITE MENUS -->
					...
					<li class="last leaf"><@security.authorize
						...
						ROLE_BASIC_INSTITUTION, ROLE_PREMIUM_INSTITUTION"> <a
						href="<@spring.url " /signin" />" title=""><@orcid.msg
