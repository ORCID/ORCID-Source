    ...
    <header class="header center">
        ...
        <div class="row">
            <div class="span3 override">
                <aside class="logo">
                    <h1><a href="${aboutUri}?lang=${locale}"><img src="<@spring.url '/static/img/orcid-logo.png'/>" alt="ORCID logo" /></a></h1>
...
<li class="expanded"><a href="${aboutUri}/organizations?lang=${locale}">${springMacroRequestContext.getMessage("public-layout.for_organizations")}</a><ul class="menu"><li class="first leaf"><a href="${aboutUri}/organizations/funders?lang=${locale}">${springMacroRequestContext.getMessage("public-layout.funders")}</a></li>
<li class="leaf"><a href="${aboutUri}/organizations/institutions?lang=${locale}" title="">${springMacroRequestContext.getMessage("public-layout.research_organizations")}</a></li>
<li class="leaf"><a href="${aboutUri}/organizations/publishers?lang=${locale}">${springMacroRequestContext.getMessage("public-layout.publishers")}</a></li>
<li class="last leaf"><a href="${aboutUri}/organizations/integrators?lang=${locale}">${springMacroRequestContext.getMessage("public-layout.integrators")}</a></li>
</ul></li>
<li class="expanded"><a href="${aboutUri}/about?lang=${locale}">${springMacroRequestContext.getMessage("public-layout.about")}</a><ul class="menu"><li class="first expanded"><a href="${aboutUri}/about/what-is-orcid?lang=${locale}" title="">${springMacroRequestContext.getMessage("public-layout.what_is_orcid")}</a><ul class="menu"><li class="first leaf"><a href="${aboutUri}/about/what-is-orcid/mission?lang=${locale}" title="">${springMacroRequestContext.getMessage("public-layout.our_mission")}</a></li>
<li class="last leaf"><a href="${aboutUri}/about/what-is-orcid/our-principles?lang=${locale}" title="">${springMacroRequestContext.getMessage("public-layout.our_principles")}</a></li>
</ul></li>
<li class="leaf"><a href="${aboutUri}/about/team?lang=${locale}" title="">${springMacroRequestContext.getMessage("public-layout.the_orcid_team")}</a></li>
<li class="expanded"><a href="${aboutUri}/about/community?lang=${locale}" title="">${springMacroRequestContext.getMessage("public-layout.the_orcid_community")}</a><ul class="menu"><li class="first leaf"><a href="${aboutUri}/about/community?lang=${locale}" title="">${springMacroRequestContext.getMessage("public-layout.working_groups")}</a></li>
<li class="leaf"><a href="${aboutUri}/about/community/participants?lang=${locale}" title="">${springMacroRequestContext.getMessage("public-layout.participants")}</a></li>
<li class="leaf"><a href="${aboutUri}/about/community/sponsors?lang=${locale}" title="">${springMacroRequestContext.getMessage("public-layout.sponsors")}</a></li>
<li class="leaf"><a href="${aboutUri}/about/community/members?lang=${locale}" title="">${springMacroRequestContext.getMessage("public-layout.members")}</a></li>
<li class="last leaf"><a href="${aboutUri}/about/community/launch-partners?lang=${locale}" title="">${springMacroRequestContext.getMessage("public-layout.launch_partners")}</a></li>
</ul></li>
<li class="expanded"><a href="${aboutUri}/about/membership?lang=${locale}" title="">Membership</a><ul class="menu"><li class="first leaf"><a href="${aboutUri}/about/membership?lang=${locale}" title="">${springMacroRequestContext.getMessage("public-layout.membership_and_subscription")}</a></li>
...
<li class="expanded"><a href="${aboutUri}/help?lang=${locale}">${springMacroRequestContext.getMessage("public-layout.help")}</a><ul class="menu"><li class="first leaf"><a href="${aboutUri}/faq-page?lang=${locale}" title="">${springMacroRequestContext.getMessage("public-layout.faq")}</a></li>
<li class="leaf"><a href="${aboutUri}/help/contact-us?lang=${locale}" title="">${springMacroRequestContext.getMessage("public-layout.contact_us")}</a></li>
