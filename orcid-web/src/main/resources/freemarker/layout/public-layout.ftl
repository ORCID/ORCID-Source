...
<li class="last leaf">
    <@security.authorize ifNotGranted="ROLE_USER, ROLE_GROUP, ROLE_PREMIUM_GROUP"><a href="<@spring.url "/signin" />" title=""><@orcid.msg 'public-layout.sign_in'/></a></@security.authorize>
    <@security.authorize ifAnyGranted="ROLE_USER, ROLE_GROUP, ROLE_PREMIUM_GROUP"><a href="<@spring.url '/signout'/>"><@orcid.msg 'public-layout.sign_out'/></a></@security.authorize>
</li>
</ul>                    </nav>
