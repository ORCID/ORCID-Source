   ...
   <div class="row">
    ...
    <div class="col-md-6 col-md-pull-6 col-sm-12 margin-bottom-box">
         ...
         <div class="row">
	        <#assign authOnClick = "">
	        <#list scopes as scope>
	        	<#assign authOnClick = authOnClick + " orcidGA.gaPush(['_trackEvent', 'RegGrowth', 'Authorize_" + scope.name()?replace("ORCID_", "") + "', 'OAuth " + displayName + "']);">          
	        </#list>
	    	<#assign denyOnClick = " orcidGA.gaPush(['_trackEvent', 'Disengagement', 'Authorize_Deny', 'OAuth " + displayName + "']);">
