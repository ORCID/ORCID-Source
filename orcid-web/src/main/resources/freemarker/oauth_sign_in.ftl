	...
	<div class="col-md-6 col-sm-12 margin-top-bottom-box" ng-controller="OauthAuthorizationController">
		...
		<#else>		    	  	        
        	...
        	<div id="register" ng-show="showRegisterForm" ng-init="loadAndInitRegistrationForm('${scopesString}','${redirect_uri}','${client_id}','${response_type}')">
        		...
        		<div>
			        <label class="control-label"><@orcid.msg 'oauth_sign_up.labelfirstname'/>
			        </label>
			        <div class="relative">			        	
			            <input name="givenNames" type="text" tabindex="1" class="input-xlarge" ng-model="registrationForm.givenNames.value" ng-model-onblur ng-change="serverValidate('GivenNames')"/>
				...
				<div>
			        ...
			        <div class="relative">
			            <input name="familyNames" type="text" tabindex="2" class="input-xlarge"  ng-model="registrationForm.familyNames.value" ng-model-onblur/>
			    ...
			    <div>
			        ...
			        <div class="relative">
			            <input name="email" type="email" tabindex="3" class="input-xlarge" ng-model="registrationForm.email.value" ng-model-onblur ng-change="serverValidate('Email')" />
			    ...
			    <div>
			        ...
			        <div class="relative">
			            <input name="confirmedEmail" type="email" tabindex="4" class="input-xlarge" ng-model="registrationForm.emailConfirm.value" ng-model-onblur ng-change="serverValidate('EmailConfirm')" />
			    ...
			    <div class="control-group">
			        ...
			        <div class="relative">
			            <input type="password" name="password" tabindex="5" class="input-xlarge" ng-model="registrationForm.password.value" ng-change="serverValidate('Password')"/>
			    ...
			    <div>
			        ...
			        <div class="relative">
			            <input type="password" name="confirmPassword" tabindex="6" class="input-xlarge" ng-model="registrationForm.passwordConfirm.value" ng-change="serverValidate('PasswordConfirm')"/>
