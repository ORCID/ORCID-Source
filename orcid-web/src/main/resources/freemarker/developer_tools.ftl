					...
					<div class="sso-api" ng-controller="SSOPreferencesCtrl">						
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<p><a href="https://orcid.org/about/membership/comparison" ><@orcid.msg 'developer_tools.client_types.description.differences.link' /></a></p>
							</div>
						</div>																
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">								
								...
								<ul class="dotted">
									...
									<li><a href="${knowledgeBaseUri}/articles/343182" ><@orcid.msg 'developer_tools.public_member.read_more' /></a></li>
								</ul>
							</div>
						</div>													
					</div>
				...
				<div ng-controller="SSOPreferencesCtrl" class="sso-api">
					...
					<div class="details" ng-show="userCredentials.clientSecret && userCredentials.clientSecret.value && !editing" ng-cloak>
						...
						<div class="row">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 dt-website">
								<p><a href="{{getClientUrl(userCredentials)}}" >{{userCredentials.clientWebsite.value}}</a></p>														
							</div>							
						</div>
						<div class="row">
							<!-- Description -->
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">								
							<h3><@orcid.msg 'developer_tools.public_member.additional_resources' /></h3>																	
							<ul class="dotted">
								<li><a href="http://members.orcid.org/api/introduction-orcid-public-api" ><@orcid.msg 'developer_tools.public_member.read_more' /></a></li>
							</ul>
						</div>
					</div>
				</div>
