		...
		<div class="popover-help-container" ng-class="${clickedClassCheck}"  style="position: absolute; left: 110px; top: 0px;">
            ...
            <div class="popover bottom" style="${popoverStyle}">
		        ...
		        <div class="popover-content">
			        ...
			        <a href="${knowledgeBaseUri}/articles/124518-orcid-privacy-settings" >${springMacroRequestContext.getMessage("privacyToggle.help.more_information")}</a>
		        </div>                
		    </div>
    	</div>				   					
	</div>
    ...
    <div class="privacy-tool">
        ...
        <div class="${btnContainerClass}">
            ...
            <ul class="privacy-dropdown-menu privacy-menu">
                ...
                <li><a class="btn" href="${helpLink}" >${springMacroRequestContext.getMessage("manage.lihelp")} <span class="caret"></span></a></li>
            </ul>
        </div>
    </div>
</#macro>
