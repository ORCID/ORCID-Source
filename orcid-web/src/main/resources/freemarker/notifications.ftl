            ...
            <table class="table table-responsive table-condensed notifications">
                ...
                <tbody>
	                ...
	                <tr ng-repeat-end ng-show="displayBody[notification.putCode]" onclick="return false;">
	                    <td colspan="4">
	                        <iframe id="{{notification.putCode}}" ng-src="{{ '<@orcid.rootPath '/notifications'/>/' + notification.notificationType + '/' + notification.putCode + '/notification.html'}}" class="notification-iframe" frameborder="0" width="100%" scrolling="no"></iframe>
	                    </td>
	                </tr>
                </tbody>
