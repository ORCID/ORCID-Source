        ...
        <div ng-show="notifications.length > 0">
            <table class="notifications" width="100%" >
                ...
                <tr ng-repeat-start="notification in notifications" ng-class="{unread: !notification.readDate, archived: notification.archivedDate}" class="header">
                    ...
                    <td>
                        <span ng-hide="notification.archivedDate"><a href="" ng-click="archive(notification.putCode)" class="glyphicon glyphicon-folder-open grey" title="${springMacroRequestContext.getMessage("notifications.archive")}"></a></span>
                    </td>
                </tr>
                <tr ng-repeat-end ng-show="displayBody[notification.putCode]">
                    <td colspan="4">
                        <iframe ng-src="{{ '<@spring.url '/notifications'/>/' + notification.notificationType + '/' + notification.putCode + '/notification.html'}}" frameborder="0" width="100%" height="300"></iframe>
                    </td>
                </tr>
            </table>
            <div ng-cloak>
