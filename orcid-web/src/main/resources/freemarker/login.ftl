	...
	<form class="form-sign-in" id="loginForm" action="<@spring.url '/signin/auth'/>" method="post">
		<div class="row">
		    ...
		    <#if (RequestParameters['alreadyClaimed'])??>
		        <div class="alert col-md-offset-3 col-md-9 col-sm-12"><@spring.message "orcid.frontend.security.already_claimed"/></div>
		    </#if>            
		    <div class="control-group col-md-offset-3 col-md-9 col-sm-12">
		    ...
		    <div class="control-group col-md-offset-3 col-md-9 col-sm-12">
		        <div>		        	
		            ...
		            <span id="ajax-loader" class="no-visible"><i id="ajax-loader" class="icon-spinner icon-large icon-spin green"></i></span>
		        </div>
		    </div>
		</div>
		<div class="row">
		    <div class="col-md-offset-3 col-md-3 col-sm-12" id="login-reset">
		        <a href="<@spring.url '/reset-password'/>">${springMacroRequestContext.getMessage("login.reset")}</a>&nbsp;&nbsp;
		    </div>
		    <div class="col-md-6 col-sm-12"  id="login-register">
