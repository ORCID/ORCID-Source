...
<p>{{userInfo.IN_DELEGATION_MODE}}</p>
<div *ngIf="userInfo.IN_DELEGATION_MODE && !userInfo.ADMIN_MENU">
   <@orcid.msg 'developer_tools.unavailable' />
</div>                               
<div *ngIf="(!userInfo.IN_DELEGATION_MODE || (userInfo.IN_DELEGATION_MODE && userInfo.ADMIN_MENU)) && !developerToolsEnabled">
    <div *ngIf="userInfo.HAS_VERIFIED_EMAIL">
