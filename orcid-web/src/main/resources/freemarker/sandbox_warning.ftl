...
<#if devSandboxUrl != ''>
    <div class="alert alert-error readme">
        ...
        <p class="emphasis small-top-margin">${springMacroRequestContext.getMessage("sandbox_warning.labelSee")} <a href="http://dev.orcid.org/release-notes#CurrentSandbox" >${springMacroRequestContext.getMessage("sandbox_warning.labelReleaseNotes")}</a>. ${springMacroRequestContext.getMessage("sandbox_warning.labelcommentandfeedback")} <a href="mailto:devsupport@orcid.org">${springMacroRequestContext.getMessage("sandbox_warning.labelorg")}</a></p>
