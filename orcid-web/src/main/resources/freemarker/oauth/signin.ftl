...
<@base>
    ...
    <div class="container oauth-login top-green-border oneStepWidth">
        ...
        <div class="row">
            ...
            <div class="login" ng-controller="OauthAuthorizationController">
					        <div class="row">
					            <div class="col-md-12">
					            ...
					            <div class="col-md-12">
					                <div class="row">
					                    <div class="col-md-12">
					                        ...
					                        <!-- Personal Login -->
					                        <!-- Login form -->
					                        <div class="personal-account-login" ng-show="personalLogin && !showRegisterForm" ng-init="loadLoginForm()" ng-cloak>
					                            <div class="login-box">
					                    ...
					                    <!-- Register form -->
					                    <div class="col-md-12">
					                        <div class="personal-account-login" ng-show="personalLogin == true && showRegisterForm" ng-init="loadRegistrationForm()" ng-cloak>
