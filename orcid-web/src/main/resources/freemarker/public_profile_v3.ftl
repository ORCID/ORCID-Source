		            		...
		            		<div class="workspace-section-header">
				                ...
				                <div id="public-researcher-urls-div" class="public-content">
				                    <#list publicResearcherUrls.researcherUrls as url>
				                        <a href="<@orcid.absUrl url.url/>"  rel="me nofollow">
				                        	<#if (url.urlName)! != "">
				                        		${url.urlName}
				                        	<#else>
				                        		${url.url.value}
				                ...
				                <div id="public-researcher-urls-div" class="public-content">				                					                
				                	<#list publicGroupedResearcherUrls?keys as url>
				                		...
				                		<#list publicGroupedResearcherUrls[url] as researcherUrl>				                							                		
				                			<#if (i == 1)>
				                				  <a href="<@orcid.absUrl researcherUrl.url/>"  rel="me nofollow"><#if (researcherUrl.urlName)! != "">${researcherUrl.urlName}<#else>${researcherUrl.url.value}</#if></a><#if url_has_next><br/></#if>
											</#if>			
											<#if (i == 1)>								
					                			<div ng-if="showSources['websites']" class="source-line separator" ng-cloak>
					                		</#if>					                			
										...
										<#list publicGroupedPersonExternalIdentifiers[external] as externalIdentifier>
											<#if (i == 1)>
  												<#if (externalIdentifier.url.value)??>
													<a href="${externalIdentifier.url.value}" >${(externalIdentifier.type)!}: ${(externalIdentifier.value)!}</a><#if external_has_next><br/><span ng-if="showSources['external-identifiers'] == false || showSources['external-identifiers'] == null"></span></#if>
    											<#else>
