									...
									<div class="popover-help-container">
							            ...
							            <div id="search-help-affiliation" class="popover bottom">
							              ...
							              <div class="popover-content">
							                <p>${springMacroRequestContext.getMessage("orcid_bio_search.popover_help.affiliation1")} <a href="https://www.ringgold.com/"  rel="noopener noreferrer">${springMacroRequestContext.getMessage("orcid_bio_search.popover_help.affiliation2")}</a> ${springMacroRequestContext.getMessage("orcid_bio_search.popover_help.affiliation3")}</p>
							              </div>
							            </div>
							         </div>
									<div class="controls">
