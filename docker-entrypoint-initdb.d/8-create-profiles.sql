...
--
-- Sign-in credentials for these seeded profiles:
--
--     user@orcid.org    / orcidLocalDev1    (0000-0000-0000-0000, USER)
--     admin@orcid.org   / orcidLocalDev1    (0000-0000-0000-0001, ADMIN)
--     member@orcid.org  / orcidLocalDev1    (0009-0000-0000-0000, GROUP)
--
-- encrypted_password is a one-way jasypt digest (PooledStringDigester,
-- SHA-512, 250000 iterations, 16-byte salt -- see orcid-core-context.xml),
-- NOT a reversible encryption, so it does not depend on either passPhrase
-- below. The previous digest here was of a password nobody had, which made
-- every seeded account unusable and left a fresh checkout with no way to
-- sign in. To change it, digest a new value with the same settings and
-- replace the string in all three rows.
--
--
-- Create profiles
--
INSERT INTO public.profile (orcid, date_created, last_modified, account_expiry, completed_date, claimed, creation_method, enabled, encrypted_password, is_selectable_sponsor, source_id, orcid_type, submission_date, indexing_status, profile_deactivation_date, activities_visibility_default, last_indexed_date, locale, primary_record, deprecated_date, group_type, referred_by, enable_developer_tools, salesforce_id, client_source_id, developer_tools_enabled_date, record_locked, used_captcha_on_registration, user_last_ip, reviewed, reason_locked, reason_locked_description, hashed_orcid, last_login, secret_for_2fa, using_2fa, deprecating_admin, deprecated_method, record_locked_date, record_locked_admin_id, signin_lock_start, signin_lock_last_attempt, signin_lock_count, auto_lock_date) VALUES ('0000-0000-0000-0000', '2024-12-05 20:17:30.31', '2024-12-05 20:17:30.037982', NULL, NULL, true, 'Direct', true, 'PUWf9VDuKw+4cGikiG+b5mk4WzgcQb21PDHmd/Iwp5PpoXZu7frBcp3Q9yXAkXm0ocs+okjtsGEufHCDYmWpRAsiImuifMOzA5Kw9rkL+t0=', NULL, NULL, 'USER', '2024-12-05 20:17:30.038+00', 'DONE', NULL, 'PUBLIC', '2024-12-05 20:17:38.210127+00', 'EN', NULL, NULL, NULL, NULL, false, NULL, NULL, NULL, false, true, '186.5.174.177', false, NULL, NULL, '92642c5c8e7d21de97aadf4c913a0817be9a1ee9a04091a22be7870489734b89', '2024-12-05 20:20:18.633868', NULL, false, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL);
INSERT INTO public.profile (orcid, date_created, last_modified, account_expiry, completed_date, claimed, creation_method, enabled, encrypted_password, is_selectable_sponsor, source_id, orcid_type, submission_date, indexing_status, profile_deactivation_date, activities_visibility_default, last_indexed_date, locale, primary_record, deprecated_date, group_type, referred_by, enable_developer_tools, salesforce_id, client_source_id, developer_tools_enabled_date, record_locked, used_captcha_on_registration, user_last_ip, reviewed, reason_locked, reason_locked_description, hashed_orcid, last_login, secret_for_2fa, using_2fa, deprecating_admin, deprecated_method, record_locked_date, record_locked_admin_id, signin_lock_start, signin_lock_last_attempt, signin_lock_count, auto_lock_date) VALUES ('0000-0000-0000-0001', '2024-12-05 20:18:52.782', '2024-12-05 20:18:52.523386', NULL, NULL, true, 'Direct', true, 'PUWf9VDuKw+4cGikiG+b5mk4WzgcQb21PDHmd/Iwp5PpoXZu7frBcp3Q9yXAkXm0ocs+okjtsGEufHCDYmWpRAsiImuifMOzA5Kw9rkL+t0=', NULL, NULL, 'ADMIN', '2024-12-05 20:18:52.524+00', 'DONE', NULL, 'PUBLIC', '2024-12-05 20:18:58.276245+00', 'EN', NULL, NULL, NULL, NULL, false, NULL, NULL, NULL, false, true, '186.5.174.177', false, NULL, NULL, '43a7ac7d5ccde49654ec71a1d5d3a7829517086206d9c0366fc9b64316e51002', '2024-12-05 20:20:32.078858', NULL, false, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL);
...
--
INSERT INTO public.profile (orcid, date_created, last_modified, account_expiry, completed_date, claimed, creation_method, enabled, encrypted_password, is_selectable_sponsor, source_id, orcid_type, submission_date, indexing_status, profile_deactivation_date, activities_visibility_default, last_indexed_date, locale, primary_record, deprecated_date, group_type, referred_by, enable_developer_tools, salesforce_id, client_source_id, developer_tools_enabled_date, record_locked, used_captcha_on_registration, user_last_ip, reviewed, reason_locked, reason_locked_description, hashed_orcid, last_login, secret_for_2fa, using_2fa, deprecating_admin, deprecated_method, record_locked_date, record_locked_admin_id, signin_lock_start, signin_lock_last_attempt, signin_lock_count, auto_lock_date) VALUES ('0009-0000-0000-0000', '2024-04-22 14:28:28.872', '2024-04-22 14:28:46.537', NULL, NULL, true, 'Direct', true, 'PUWf9VDuKw+4cGikiG+b5mk4WzgcQb21PDHmd/Iwp5PpoXZu7frBcp3Q9yXAkXm0ocs+okjtsGEufHCDYmWpRAsiImuifMOzA5Kw9rkL+t0=', NULL, NULL, 'GROUP', '2024-04-22 14:28:28.865+00', 'DONE', NULL, 'PRIVATE', '2024-04-22 15:28:39.641078+00', 'EN', NULL, NULL, 'PREMIUM', NULL, false, '123456789012345', NULL, NULL, false, false, NULL, true, NULL, NULL, '716ba0ab70d546a7b7578118a7aec863564e555ebc21caa0b3d9fc17dec87383', NULL, NULL, false, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
