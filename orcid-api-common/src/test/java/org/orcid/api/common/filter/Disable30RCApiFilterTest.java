...
public class Disable30RCApiFilterTest {
    ...
    public void filterFeatureEnabledLocalHostRootPathTest() throws ServletException, IOException {
        ...
        togglzRule.enable(Features.V3_DISABLE_RELEASE_CANDIDATES);
    ...
    @Test
    public void filterFeatureEnabledLocalHostV20rc2PathTest() throws ServletException, IOException {
    ...
    @Test
    public void filterFeatureEnabledOrcidV20_rc2PathTest() throws ServletException, IOException {
    ...
    @Test
    public void filterFeatureEnabledOrcidV20_rc4PathTest() throws ServletException, IOException {
        when(request.getRequestURL()).thenReturn(new StringBuffer(ORCID_URL + CONTEXT_PATH + "/v2.0_rc2" + PATH));
        when(request.getAttribute(ApiVersionFilter.API_VERSION_REQUEST_ATTRIBUTE_NAME)).thenReturn("2.0_rc2");
        togglzRule.enable(Features.V3_DISABLE_RELEASE_CANDIDATES);
        String requestUri = CONTEXT_PATH + "/v2.0_rc2" + PATH;
    ...
    /**
     * For calls to any other env, redirect uri should not return the context
     * path
     */
    @Test
    public void filterFeatureEnabledOrcidV30rc1PathTest() throws ServletException, IOException {
        ...
        verify(response, times(1)).setHeader("Location", "/v3.0" + PATH);
    }

    @Test
    public void filterFeatureEnabledOrcidV30rc2PathTest() throws ServletException, IOException {
    ...
    public void filterFeatureEnabledLocalhostV30rc1PathTest() throws ServletException, IOException {
        ...
        verify(response, times(1)).setStatus(308);
        verify(chain, never()).doFilter(Mockito.any(), Mockito.any());
        verify(response, times(1)).setHeader("Location", LOCALHOST_URL + CONTEXT_PATH + "/v3.0" + PATH);
    }
     ...
     */
    @Test
    public void filterFeatureDisabledOrcidV30rc1PathTest() throws ServletException, IOException {
        when(request.getRequestURL()).thenReturn(new StringBuffer(ORCID_URL + CONTEXT_PATH + "/v3.0_rc1" + PATH));
        when(request.getAttribute(ApiVersionFilter.API_VERSION_REQUEST_ATTRIBUTE_NAME)).thenReturn("3.0_rc1");
        togglzRule.disable(Features.V3_DISABLE_RELEASE_CANDIDATES);
        String requestUri = CONTEXT_PATH + "/v3.0_rc1" + PATH;
        when(request.getRequestURI()).thenReturn(requestUri);
        filter.doFilter(request, response, chain);
    ...
    @Test
    public void filterFeatureDisabledOrcidV30rc2PathTest() throws ServletException, IOException {
        when(request.getRequestURL()).thenReturn(new StringBuffer(ORCID_URL + CONTEXT_PATH + "/v.0_rc2" + PATH));
        when(request.getAttribute(ApiVersionFilter.API_VERSION_REQUEST_ATTRIBUTE_NAME)).thenReturn("3.0_rc2");
        togglzRule.disable(Features.V3_DISABLE_RELEASE_CANDIDATES);
        String requestUri = CONTEXT_PATH + "/v3.0_rc2" + PATH;
        when(request.getRequestURI()).thenReturn(requestUri);
    ...
    @Test
    public void filterFeatureDisableLocalhostV30rc1PathTest() throws ServletException, IOException {
        when(request.getRequestURL()).thenReturn(new StringBuffer(LOCALHOST_URL + CONTEXT_PATH + "/v3.0_rc1" + PATH));
        when(request.getAttribute(ApiVersionFilter.API_VERSION_REQUEST_ATTRIBUTE_NAME)).thenReturn("3.0_rc1");
        togglzRule.disable(Features.V3_DISABLE_RELEASE_CANDIDATES);
        String requestUri = CONTEXT_PATH + "/v3.0_rc1" + PATH;
    ...
    @Test
    public void filterFeatureDisableLocalhostV30rc2PathTest() throws ServletException, IOException {
        when(request.getRequestURL()).thenReturn(new StringBuffer(LOCALHOST_URL + CONTEXT_PATH + "/v3.0_rc2" + PATH));
        when(request.getAttribute(ApiVersionFilter.API_VERSION_REQUEST_ATTRIBUTE_NAME)).thenReturn("3.0_rc2");
        togglzRule.disable(Features.V3_DISABLE_RELEASE_CANDIDATES);
        String requestUri = CONTEXT_PATH + "/v3.0_rc2" + PATH;
