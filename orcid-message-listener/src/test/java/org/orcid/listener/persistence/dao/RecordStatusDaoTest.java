...
public class RecordStatusDaoTest {
    ...
    public void createTest() {
        ...
        recordStatusDao.create(orcid, AvailableBroker.DUMP_STATUS_2_0_API, Constants.OK);
    ...
    public void existsTest() {
        recordStatusDao.create("0000-0000-0001", AvailableBroker.DUMP_STATUS_2_0_API, Constants.OK);
        recordStatusDao.create("0000-0000-0002", AvailableBroker.DUMP_STATUS_2_0_API, Constants.OK);
        recordStatusDao.create("0000-0000-0003", AvailableBroker.DUMP_STATUS_2_0_API, Constants.OK);
        recordStatusDao.create("0000-0000-0004", AvailableBroker.DUMP_STATUS_2_0_API, Constants.OK);
    ...
    public void getTest() {
        ...
        recordStatusDao.create(orcid, AvailableBroker.DUMP_STATUS_2_0_API, 100);
        RecordStatusEntity entity = recordStatusDao.get(orcid);
        assertNotNull(entity);
        assertEquals(orcid, entity.getId());
        assertEquals(Integer.valueOf(100), entity.getDumpStatus20Api());
        assertEquals(Integer.valueOf(0), entity.getSolrStatus20Api());
        assertNotNull(entity.getDateCreated());
        assertNotNull(entity.getLastModified());
        assertNotNull(entity.getLastIndexedDump20Api());
    ...
    public void getFailedElementsTest() {
        recordStatusDao.create("0000-0000-0001-0000", AvailableBroker.DUMP_STATUS_2_0_API, 1);
        ...
        recordStatusDao.create("0000-0000-0001-0003", AvailableBroker.DUMP_STATUS_2_0_API, Constants.OK);
        ...
        recordStatusDao.create("0000-0000-0001-0006", AvailableBroker.DUMP_STATUS_2_0_API, Constants.OK);
        ...
        recordStatusDao.create("0000-0000-0001-0009", AvailableBroker.DUMP_STATUS_2_0_API, Constants.OK);
        ...
        assertEquals(Integer.valueOf(1), e1.getDumpStatus20Api());
