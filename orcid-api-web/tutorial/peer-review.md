...
**If you are using ISSN, search first before creating new Group-ids**. You *do not* need to create a new group-id if you are using an ISSN. Post your peer review with the ISSN in the `<peer-review:review-group-id>` field  as in the example [here](https://github.com/ORCID/ORCID-Source/blob/master/orcid-model/src/main/resources/record_3.0/samples/write_samples/peer-review-full-3.0.xml) and the group id will be created when you post your peer-review. 
