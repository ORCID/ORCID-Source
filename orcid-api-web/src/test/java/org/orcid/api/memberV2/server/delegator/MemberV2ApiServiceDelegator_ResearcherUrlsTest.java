...
public class MemberV2ApiServiceDelegator_ResearcherUrlsTest extends DBUnitTest {
	...
	public void testViewResearcherUrls() {
		...
		for (ResearcherUrl rUrl : researcherUrls.getResearcherUrls()) {
			assertThat(rUrl.getPutCode(), anyOf(equalTo(Long.valueOf(2)), equalTo(Long.valueOf(3)),
					equalTo(Long.valueOf(5)), equalTo(Long.valueOf(7)), equalTo(Long.valueOf(8))));
			Utils.verifyLastModified(researcherUrls.getLastModifiedDate());
	...
	public void testDeleteResearcherUrl() {
		SecurityContextTestUtils.setUpSecurityContext("4444-4444-4444-4445", ScopePathType.PERSON_UPDATE,
				ScopePathType.PERSON_READ_LIMITED);
