...
public class MemberV2ApiServiceVersionedDelegatorImpl
	...
	public Response viewActivities(String orcid) {
		...
		return downgradeResponse(memberV2ApiServiceDelegator
				.viewActivities(orcid));
	}

	@Override
	public Response viewWork(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator.viewWork(orcid,
				putCode));
	}
	...
	public Response viewWorkSummary(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator.viewWorkSummary(
				orcid, putCode));
	}
	...
	public Response updateWork(String orcid, Long putCode, Object work) {
		checkProfileStatus(orcid);
		work = upgradeObject(work);
		return downgradeResponse(memberV2ApiServiceDelegator.updateWork(orcid,
				putCode, work));
	}
	...
	public Response viewFunding(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator.viewFunding(orcid,
				putCode));
	}
	...
	public Response viewFundingSummary(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator
				.viewFundingSummary(orcid, putCode));
	}
	...
	public Response updateFunding(String orcid, Long putCode, Object funding) {
		checkProfileStatus(orcid);
		funding = upgradeObject(funding);
		return downgradeResponse(memberV2ApiServiceDelegator.updateFunding(
				orcid, putCode, funding));
	}
	...
	public Response viewEducation(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator.viewEducation(
				orcid, putCode));
	}
	...
	public Response viewEducationSummary(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator
				.viewEducationSummary(orcid, putCode));
	}
	...
	public Response updateEducation(String orcid, Long putCode, Object education) {
		checkProfileStatus(orcid);
		education = upgradeObject(education);
		return downgradeResponse(memberV2ApiServiceDelegator.updateEducation(
				orcid, putCode, education));
	}

	@Override
	public Response viewEmployment(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator.viewEmployment(
				orcid, putCode));
	}
	...
	public Response viewEmploymentSummary(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator
				.viewEmploymentSummary(orcid, putCode));
	}
	...
	@Override
	public Response updateEmployment(String orcid, Long putCode,
			Object employment) {
		checkProfileStatus(orcid);
		employment = upgradeObject(employment);
		return downgradeResponse(memberV2ApiServiceDelegator.updateEmployment(
				orcid, putCode, employment));
	}
	...
	public Response viewPeerReview(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator.viewPeerReview(
				orcid, putCode));
	}
	...
	public Response viewPeerReviewSummary(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator
				.viewPeerReviewSummary(orcid, putCode));
	}
	...
	@Override
	public Response updatePeerReview(String orcid, Long putCode,
			Object peerReview) {
		checkProfileStatus(orcid);
		peerReview = upgradeObject(peerReview);
		return downgradeResponse(memberV2ApiServiceDelegator.updatePeerReview(
				orcid, putCode, peerReview));
	}
	...
	public Response updateGroupIdRecord(Object groupIdRecord, Long putCode) {
		groupIdRecord = upgradeObject(groupIdRecord);
		return downgradeResponse(memberV2ApiServiceDelegator
				.updateGroupIdRecord(groupIdRecord, putCode));
	}
	...
	public Response viewGroupIdRecords(String pageSize, String pageNum) {
		return downgradeResponse(memberV2ApiServiceDelegator
				.viewGroupIdRecords(pageSize, pageNum));
	}
	...
	public Response viewResearcherUrls(String orcid) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator
				.viewResearcherUrls(orcid));
	}

	@Override
	public Response viewResearcherUrl(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator.viewResearcherUrl(
				orcid, putCode));
	}

	@Override
	public Response updateResearcherUrl(String orcid, Long putCode,
			Object researcherUrl) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator
				.updateResearcherUrl(orcid, putCode, researcherUrl));
	}

	@Override
	public Response createResearcherUrl(String orcid, Object researcherUrl) {
		checkProfileStatus(orcid);
		return memberV2ApiServiceDelegator.createResearcherUrl(orcid,
				researcherUrl);
	}
	...
	public Response viewOtherNames(String orcid) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator
				.viewOtherNames(orcid));
	}

	@Override
	public Response viewOtherName(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator.viewOtherName(
				orcid, putCode));
	}
	...
	public Response updateOtherName(String orcid, Long putCode, Object otherName) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator.updateOtherName(
				orcid, putCode, otherName));
	}
	...
	public Response viewExternalIdentifier(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator
				.viewExternalIdentifier(orcid, putCode));
	}
	...
	public Response updateExternalIdentifier(String orcid, Long putCode,
		...
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator
				.updateExternalIdentifier(orcid, putCode, externalIdentifier));
	}
	...
	public Response createExternalIdentifier(String orcid,
			Object externalIdentifier) {
		checkProfileStatus(orcid);
		return memberV2ApiServiceDelegator.createExternalIdentifier(orcid,
				externalIdentifier);
	}
	...
	public Response deleteExternalIdentifier(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return memberV2ApiServiceDelegator.deleteExternalIdentifier(orcid,
				putCode);
	}

	@SuppressWarnings({ "rawtypes", "unchecked" })
	public void setMemberV2ApiServiceDelegator(
	...
	public Response viewKeyword(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator.viewKeyword(orcid,
				putCode));
	}
	...
	public Response updateKeyword(String orcid, Long putCode, Object keyword) {
		checkProfileStatus(orcid);
		keyword = upgradeObject(keyword);
		return downgradeResponse(memberV2ApiServiceDelegator.updateKeyword(
				orcid, putCode, keyword));
	}
	...
	public Response viewAddress(String orcid, Long putCode) {
		checkProfileStatus(orcid);
		return downgradeResponse(memberV2ApiServiceDelegator.viewAddress(orcid,
				putCode));
	}
	...
	public Response updateAddress(String orcid, Long putCode, Object address) {
		checkProfileStatus(orcid);
		address = upgradeObject(address);
		return downgradeResponse(memberV2ApiServiceDelegator.updateAddress(
				orcid, putCode, address));
	}
	...
	private Response downgradeResponse(Response response) {
		...
		if (entity != null) {
			result = v2VersionConverterChain.downgrade(new V2Convertible(
					entity, MemberV2ApiServiceDelegator.LATEST_V2_VERSION),
					externalVersion);
		}
		return Response.fromResponse(response)
				.entity(result.getObjectToConvert()).build();
	}

	private Object upgradeObject(Object entity) {
		V2Convertible result = null;
		if (entity != null) {
			result = v2VersionConverterChain.upgrade(new V2Convertible(entity,
					externalVersion),
		...
		if (profileDao.isProfileDeprecated(orcid)) {
			...
			if (entity.getDeprecatedDate() != null) {
				XMLGregorianCalendar calendar = DateUtils
						.convertToXMLGregorianCalendar(entity
								.getDeprecatedDate());
				params.put(OrcidDeprecatedException.DEPRECATED_DATE,
						calendar.toString());
			}
