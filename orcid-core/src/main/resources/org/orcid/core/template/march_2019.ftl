...
<@emailMacros.msg "email.march_2019.paragraph_4.part_1" /><@emailMacros.space /><@emailMacros.msg "email.march_2019.paragraph_4.part_2" /><@emailMacros.space />(https://support.orcid.org/hc/en-us/articles/360006894494-Visibility-preferences)<@emailMacros.space /><@emailMacros.msg "email.march_2019.paragraph_4.part_3" />

<@emailMacros.msg "email.march_2019.paragraph_5.part_1" /><@emailMacros.space /><@emailMacros.msg "email.march_2019.paragraph_5.part_2" /><@emailMacros.space />(https://orcid.org/blog/2019/03/20/don%E2%80%99t-lose-access-your-orcid-record)
