...
<html>
	...
	<body>
		<div style="padding: 20px; padding-top: 0px;">
	        ...
	        <p style="font-family: arial, helvetica, sans-serif; font-size: 15px; color: #494A4C;">
                <@emailMacros.msg "email.deactivate.if_you_did" /> <a href="https://support.orcid.org/hc/en-us/requests/new" target="_blank">https://support.orcid.org/hc/en-us/requests/new</a> <@emailMacros.msg "email.deactivate.gdpr_or_by_replying" />
		    </p>
