	...
	<body>
		<div style="padding: 20px; padding-top: 0px;">
		    ...
		    <p style="font-family: arial, helvetica, sans-serif; font-size: 15px; color: #666666;">
		    	...
		    	<@emailMacros.msg "email.service_announcement.body_inbox1" /><a href="http://orcid.org/inbox" target="_blank"><@emailMacros.msg "email.service_announcement.inbox_link" /></a><@emailMacros.msg "email.service_announcement.body_inbox2" /><a href="<@emailMacros.knowledgeBaseUri />/knowledgebase/articles/665437" target="_blank"><@emailMacros.msg "email.service_announcement.inbox_about_link" /></a><@emailMacros.msg "email.service_announcement.body_inbox3" /><@emailMacros.msg "email.service_announcement.body_inbox4" />
		    </p>
		    <p style="font-family: arial, helvetica, sans-serif; font-size: 15px; color: #666666;">
		    	<span style="font-weight:bold"><@emailMacros.msg "email.service_announcement.body_permission_title" /></span><br><@emailMacros.msg "email.service_announcement.body_permission1" /> <a href="http://www.crossref.org/" target="_blank"><@emailMacros.msg "email.service_announcement.crossref_link" /></a><@emailMacros.msg "email.service_announcement.body_permission2" /><a href="https://www.datacite.org/" target="_blank"><@emailMacros.msg "email.service_announcement.datacite_link" /></a><@emailMacros.msg "email.service_announcement.body_permission3" /><a href="http://orcid.org/blog/2015/01/13/new-webinar-metadata-round-trip" target="_blank"><@emailMacros.msg "email.service_announcement.updates_link" /></a><@emailMacros.msg "email.service_announcement.body_permission4" /><a href="<@emailMacros.knowledgeBaseUri />/knowledgebase/articles/665437" target="_blank"><@emailMacros.msg "email.service_announcement.inbox_about_link" /></a><@emailMacros.msg "email.service_announcement.body_permission5" /><@emailMacros.msg "email.service_announcement.body_permission6" />
		    </p>
		    <p style="font-family: arial, helvetica, sans-serif; font-size: 15px; color: #666666;">
		  	...
		  	<p style="font-family: arial,  helvetica, sans-serif;font-size: 15px;color: #666666;">
				...
				<ul style="font-family: arial,  helvetica, sans-serif;font-size: 15px;color: #666666;">
				   ...
				   <li>
				    ...
				    <li>
				    	<@emailMacros.msg "email.service_announcement.body_updates7" /><a href="<@emailMacros.knowledgeBaseUri />/knowledgebase/articles/460004" target="_blank"><@emailMacros.msg "email.service_announcement.here_link" /></a><@emailMacros.msg "email.service_announcement.body_updates8" />
				    </li>
				</ul>
		   </p>
		   <p style="font-family: arial,  helvetica, sans-serif;font-size: 15px;color: #666666;">
