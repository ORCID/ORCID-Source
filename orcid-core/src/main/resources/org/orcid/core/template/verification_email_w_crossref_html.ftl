...
<div style="padding: 20px; padding-top: 0px;">
	<img src="http://orcid.org/sites/all/themes/orcid/img/orcid-logo.png" alt="" border="0" />
    <hr />
	...
	<p style="font-family: arial,  helvetica, sans-serif;font-size: 13px; color: #666666;">
		You have received this e-mail in the genuine belief that its contents would be of interest to you. To opt-out of messages from ORCID please go to your account settings page <a href="http://orcid.org/account">http://orcid.org/account</a>.
    </p>
 </div>