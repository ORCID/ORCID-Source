...
${creatorName} has registered to create an ORCID account for you. This account will provide you with a unique research identifier that you can use in your publications and grants. The account provides a place to list your publications, grants, patents, and other information about your professional research activities.

To make creating your ORCID record easier, ${creatorName} has already entered information into your account. Please review it.

If you are satisfied with the information in your account, you need not take further action. If you see information that is incorrect; that should be private; or if you simply do not wish to have an account at this time, you can use the link below to make any changes you like -- the ORCID system gives you complete control over the privacy of your profile. When your account does become active, any information ${creatorName} marked as "public" will viewable in the ORCID Registry and freely available to the public, unless you change the privacy settings.
