 ...
 * 
 */
public class OrcidMessageVersionConverterImplV1_0_16ToV1_0_17 implements OrcidMessageVersionConverter {

    private static final String FROM_VERSION = "1.0.16";
    private static final String TARGET_VERSION = "1.0.17";
