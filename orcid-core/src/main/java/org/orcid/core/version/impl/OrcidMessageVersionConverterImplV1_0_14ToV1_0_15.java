 ...
 * 
 */
public class OrcidMessageVersionConverterImplV1_0_14ToV1_0_15 implements OrcidMessageVersionConverter {

    private static final String FROM_VERSION = "1.0.14";
    private static final String TO_VERSION = "1.0.15";
