            ...
            if (orcidActivities != null) {
                ...
                if (orcidWorks != null) {
                    for (OrcidWork orcidWork : orcidWorks.getOrcidWork()) {
                        ...
                        if(OrcidMessageVersionConverterImplV1_0_22ToV1_0_23.EMPTY_TITLE.equals(orcidWork.getWorkTitle().getTitle()))
                ...
                if (orcidWorks != null) {
                    for (OrcidWork orcidWork : orcidWorks.getOrcidWork()) {
                        ...
                        if(workTitle == null){
                            ...
                            Title title = new Title(OrcidMessageVersionConverterImplV1_0_22ToV1_0_23.EMPTY_TITLE);
                            ...
                            workTitle.getTitle().setContent(OrcidMessageVersionConverterImplV1_0_22ToV1_0_23.EMPTY_TITLE);
                        }
                    }
                }
            }
