...
public enum OrcidVisibilityDefaults {
    ...
    AFFILIATE_DETAIL_DEFAULT(Visibility.PUBLIC), AFFILIATE_NAME_DEFAULT(Visibility.PUBLIC), FUNDING_DEFAULT(Visibility.PUBLIC), ALTERNATIVE_EMAIL_DEFAULT(
            Visibility.LIMITED), NAMES_DEFAULT(Visibility.PUBLIC), COUNTRY_DEFAULT(Visibility.PUBLIC), DELEGATION_DEFAULT(Visibility.PRIVATE), PRIMARY_EMAIL_DEFAULT(
            ...
            Visibility.PUBLIC), CONTRIBUTOR_VISIBILITY_DEFAULT(Visibility.PUBLIC);
