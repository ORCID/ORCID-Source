...
public enum OrcidVisibilityDefaults {
    ...
    AFFILIATE_DETAIL_DEFAULT(Visibility.PUBLIC), AFFILIATE_NAME_DEFAULT(Visibility.PUBLIC), FUNDING_DEFAULT(Visibility.PUBLIC), ALTERNATIVE_EMAIL_DEFAULT(Visibility.LIMITED), CREDIT_NAME_DEFAULT(
            Visibility.PUBLIC), COUNTRY_DEFAULT(Visibility.PUBLIC), DELEGATION_DEFAULT(Visibility.PRIVATE), PRIMARY_EMAIL_DEFAULT(Visibility.LIMITED), EXTERNAL_IDENTIFIER_DEFAULT(
