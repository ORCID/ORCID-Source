...
public enum OrcidVisibilityDefaults {
    ...
    AFFILIATE_DETAIL_DEFAULT(Visibility.PUBLIC), AFFILIATE_NAME_DEFAULT(Visibility.PUBLIC), ALTERNATIVE_EMAIL_DEFAULT(Visibility.LIMITED), CREDIT_NAME_DEFAULT(Visibility.PUBLIC),COUNTRY_DEFAULT(Visibility.LIMITED),DELEGATION_DEFAULT(
            Visibility.PRIVATE), PRIMARY_EMAIL_DEFAULT(Visibility.LIMITED),EXTERNAL_IDENTIFIER_DEFAULT(Visibility.PUBLIC), KEYWORD_DEFAULT(Visibility.PUBLIC), OTHER_NAMES_DEFAULT(Visibility.PUBLIC), PAST_INSTITUTION_DEFAULT(
