...
public enum OrcidVisibilityDefaults {
    ...
    AFFILIATE_DETAIL_DEFAULT(Visibility.PUBLIC), AFFILIATE_NAME_DEFAULT(Visibility.PUBLIC), ALTERNATIVE_EMAIL_DEFAULT(Visibility.LIMITED), CREDIT_NAME_DEFAULT(
            ...
            Visibility.PUBLIC), SHORT_DESCRIPTION_DEFAULT(Visibility.PUBLIC), SUBJECTS_DEFAULT(Visibility.PUBLIC), WORKS_DEFAULT(Visibility.PUBLIC), BIOGRAPHY_DEFAULT(Visibility.PUBLIC);
