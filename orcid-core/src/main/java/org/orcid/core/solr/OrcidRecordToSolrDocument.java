                ...
                for(ResearchResource r : researchResources) {
                    if(r.getProposal() != null) {
                        ...
                        if(proposal.getHosts() != null) {
                            for(org.orcid.jaxb.model.v3.release.common.Organization organization : proposal.getHosts().getOrganization()) {
                        ...
                        if(proposal.getExternalIdentifiers() != null && proposal.getExternalIdentifiers().getExternalIdentifier() != null) {
                            for(org.orcid.jaxb.model.v3.release.record.ExternalID id : proposal.getExternalIdentifiers().getExternalIdentifier()) {
                                //old way
                                if (!allExternalIdentifiers.containsKey(id.getType())){
                                    allExternalIdentifiers.put(id.getType(), new ArrayList<String>());
                                }
                    ...
                    if(r.getResourceItems() != null) {
                        ...
                        for(ResearchResourceItem item : r.getResourceItems()) {
                            ...
                            if(item.getHosts() != null) {
                                for(org.orcid.jaxb.model.v3.release.common.Organization organization : item.getHosts().getOrganization()) {
                            ...
                            for(org.orcid.jaxb.model.v3.release.record.ExternalID id : item.getExternalIdentifiers().getExternalIdentifier()) {
                                //old way
                                if (!allExternalIdentifiers.containsKey(id.getType())){
                                    allExternalIdentifiers.put(id.getType(), new ArrayList<String>());
                                }
                    ...
                    if (e.getOrganization() !=null){                        
                        ...
                        if (e.getOrganization().getDisambiguatedOrganization() != null) {
                            ...
                            if(SolrConstants.RINGGOLD_ORG_TYPE.equals(sourceType)) {
                                ...
                                organisationIds.get(SolrConstants.ROR_ORGANISATION_ID).add(e.getOrganization().getDisambiguatedOrganization().getDisambiguatedOrganizationIdentifier());
                            } 
                        }                            
                    }
                }
