...
public class EducationExternalIdentifier implements Serializable, JSONIdentifierAdapter<ExternalID> {
    ...
    protected EducationExternalIdentifier() {
    }

    public EducationExternalIdentifier(ExternalID recordPojo) {
    ...
    public static EducationExternalIdentifier fromDBJSONString(String dbJSON) {
        return JsonUtils.readObjectFromJsonString(dbJSON, EducationExternalIdentifier.class);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        EducationExternalIdentifier other = (EducationExternalIdentifier) obj;
        if (type == null) {
            if (other.type != null)
                return false;
