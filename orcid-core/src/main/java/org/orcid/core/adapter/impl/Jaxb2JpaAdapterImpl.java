...
import org.orcid.jaxb.model.record_2_rc2.WorkExternalIdentifierType;
...
public class Jaxb2JpaAdapterImpl implements Jaxb2JpaAdapter {
    ...
    private String getWorkExternalIdsJson(OrcidWork work) {
        ...
        org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifiers recordExternalIdentifiers = org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifiers.valueOf(work.getWorkExternalIdentifiers());
         ...
         * */
        for(org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifier extId : recordExternalIdentifiers.getExternalIdentifier()) {
