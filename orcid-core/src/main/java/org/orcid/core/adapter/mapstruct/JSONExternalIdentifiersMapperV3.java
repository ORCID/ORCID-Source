...
import org.orcid.core.adapter.mapstruct.jsonidentifier.JSONExternalIdentifier;
import org.orcid.core.adapter.mapstruct.jsonidentifier.JSONExternalIdentifiers;
    ...
    public ExternalIDs convertFrom(String source) {
        ...
        for (JSONExternalIdentifier externalIdentifier : externalIdentifiers.getExternalIdentifier()) {
            ...
            if (!PojoUtil.isEmpty(externalIdentifier.getValue())) {
                ...
                if (StringUtils.isNotBlank(normalised)) {
