        ...
        for (final BigInteger workId : idsToUpgrade) {
            System.out.println("Processing work id: " + workId);
                ...
                protected void doInTransactionWithoutResult(TransactionStatus status) {                
                    ...
                    org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifiers newExtIds = new org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifiers();
                    if (oldExtIds != null) {
                        for (org.orcid.jaxb.model.message.WorkExternalIdentifier oldExtId : oldExtIds.getWorkExternalIdentifier()) {
                            org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifier newExtId = org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifier.fromMessageExtId(oldExtId);
