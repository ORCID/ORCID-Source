...
class OrcidWorkMatcher {
    ...
    public boolean equals(Object o) {
        ...
        if (this.orcidWork.getShortDescription() != null ? !this.orcidWork.getShortDescription().equals(orcidWork.getShortDescription()) :
            orcidWork.getShortDescription() != null) {
            return false;
        }
        ...
        if (this.orcidWork.getWorkContributors() != null ? !this.orcidWork.getWorkContributors().equals(orcidWork.getWorkContributors()) :
                orcidWork.getWorkContributors() != null) {
            return false;
        }
        if (this.orcidWork.getWorkExternalIdentifiers() != null ? !this.orcidWork.getWorkExternalIdentifiers().equals(orcidWork.getWorkExternalIdentifiers()) :
                orcidWork.getWorkExternalIdentifiers() != null) {
            return false;
        }
