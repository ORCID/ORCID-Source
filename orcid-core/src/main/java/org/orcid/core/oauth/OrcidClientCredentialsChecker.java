...
public class OrcidClientCredentialsChecker {
    ...
    private void validateScope(ClientDetails clientDetails, Set<String> scopes) {
        ...
        if (clientDetails.isScoped()) {
            ...
            } else if (!containsAny(validScope, ScopePathType.ORCID_PROFILE_CREATE, ScopePathType.WEBHOOK, ScopePathType.NOTIFICATION) && !scopes.contains(ScopePathType.READ_PUBLIC.value())
                    && scopes.size() == 1) {
