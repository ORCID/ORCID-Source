...
public class NotificationManagerImpl implements NotificationManager {
    ...
    public void sendApiRecordCreationEmail(String toEmail, OrcidProfile createdProfile) {
        ...
        String creatorName = (source == null || source.getSourceName() == null || source.getSourceName().getContent() == null) ? source.getSourceOrcid().getPath() : source.getSourceName().getContent();
    ...
    public void sendClaimReminderEmail(OrcidProfile orcidProfile, int daysUntilActivation) {
        ...
        templateParams.put("creatorName", (source == null || source.getSourceName() == null || source.getSourceName().getContent() == null) ? source.getSourceOrcid().getPath() : source.getSourceName().getContent());
        templateParams.put("baseUri", baseUri);
