...
public class OrgManagerImpl implements OrgManager {
    ...
    public OrgEntity getOrgEntity(OrganizationHolder holder) {
        ...
        org.orcid.jaxb.model.common_rc4.Organization organization = holder.getOrganization();
        orgEntity.setName(organization.getName());
        org.orcid.jaxb.model.common_rc4.OrganizationAddress address = organization.getAddress();
