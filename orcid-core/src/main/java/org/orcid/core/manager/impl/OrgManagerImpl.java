...
public class OrgManagerImpl implements OrgManager {
    ...
    public OrgEntity getOrgEntity(OrganizationHolder holder) {
        ...
        org.orcid.jaxb.model.common_rc2.Organization organization = holder.getOrganization();
        orgEntity.setName(organization.getName());
        org.orcid.jaxb.model.common_rc2.OrganizationAddress address = organization.getAddress();
