...
public class ActivityCacheManagerImpl extends Object implements ActivityCacheManager {
        ...
        if (peerReviews != null) {
            if (!peerReviews.isEmpty()) {                
                for(PeerReview peerReview : peerReviews) {
                    if(peerReview.getVisibility().equals(org.orcid.jaxb.model.common_rc4.Visibility.PUBLIC)) {
    ...
    public String getPublicCreditName(ProfileEntity profile) {
        ...
        if(profile != null) {
            if(profile.getRecordNameEntity() != null && org.orcid.jaxb.model.common_rc4.Visibility.PUBLIC.equals(profile.getRecordNameEntity().getVisibility())) {            
