...
public class IdentifierTypeManagerImpl implements IdentifierTypeManager{
    ...
    private IdentifierTypeConverter adapter = new IdentifierTypeConverter();
    ...
    /** Returns an immutable map of Name->identifierType objects.
     * 
     */
    @Override
    @Cacheable("identifierTypesMap")
    ...
    @Override
    @CacheEvict(value = { "identifierTypes", "identifierTypesMap" }, allEntries = true)
    ...
    public IdentifierType updateIdentifierType(IdentifierType id) {
        IdentifierTypeEntity entity = idTypeDao.getEntityByName(id.getName()); 
