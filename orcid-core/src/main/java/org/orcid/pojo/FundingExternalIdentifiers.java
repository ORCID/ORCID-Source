...
public class FundingExternalIdentifiers implements Serializable {
    ...
    public org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifiers toRecordPojo() {
        org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifiers result = new org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifiers();
        if (!this.getFundingExternalIdentifier().isEmpty()) {
            for (FundingExternalIdentifier fei : this.getFundingExternalIdentifier()) {
    ...
    public static FundingExternalIdentifiers fromRecordPojo(org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifiers recordPojo) {
        if (recordPojo == null)
            return null;
        FundingExternalIdentifiers result = new FundingExternalIdentifiers();
        if (!recordPojo.getExternalIdentifier().isEmpty()) {
            for (org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifier recordEi : recordPojo.getExternalIdentifier()) {                               
