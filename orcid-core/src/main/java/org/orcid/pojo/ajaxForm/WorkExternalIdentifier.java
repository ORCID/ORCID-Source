...
public class WorkExternalIdentifier implements ErrorsInterface, Serializable {
    ...
    public static WorkExternalIdentifier valueOf(org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifier workExternalIdentifier) {
        WorkExternalIdentifier wi = new WorkExternalIdentifier();
        if (workExternalIdentifier != null) {
            if (workExternalIdentifier.getWorkExternalIdentifierId() != null)
                wi.setWorkExternalIdentifierId(Text.valueOf(workExternalIdentifier.getWorkExternalIdentifierId().getContent()));
    ...
    public org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifier toRecordWorkExternalIdentifier() {
        org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifier we = new org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifier();
        if (!PojoUtil.isEmpty(this.getWorkExternalIdentifierId())) 
            we.setWorkExternalIdentifierId(new org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifierId(this.getWorkExternalIdentifierId().getValue()));
        if (!PojoUtil.isEmpty(this.getWorkExternalIdentifierType()))
            we.setWorkExternalIdentifierType(org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifierType.fromValue(this.getWorkExternalIdentifierType().getValue()));
