...
import org.orcid.jaxb.model.record_2_rc1.CitationType;
...
public class WorkForm implements ErrorsInterface, Serializable {
    ...
    private static void populateExternalIdentifiers(Work work, WorkForm workForm) {
        ...
        if(work.getExternalIdentifiers() != null) {        
            org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifiers extIds = work.getExternalIdentifiers();
            if (extIds != null) {
                for (org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifier extId : extIds.getWorkExternalIdentifier()) {
                    
                    if(extId.getRelationship() == null) {
                        if(org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifierType.ISSN.equals(extId.getWorkExternalIdentifierType())) {
                            if(org.orcid.jaxb.model.record_2_rc1.WorkType.BOOK.equals(work.getWorkType())) {
                                extId.setRelationship(Relationship.PART_OF);
                            } else {
                                extId.setRelationship(Relationship.SELF);
                            }
                        } else if(org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifierType.ISBN.equals(extId.getWorkExternalIdentifierType())) {
                            if(org.orcid.jaxb.model.record_2_rc1.WorkType.BOOK_CHAPTER.equals(work.getWorkType()) || org.orcid.jaxb.model.record_2_rc1.WorkType.CONFERENCE_PAPER.equals(work.getWorkType())) {
                                extId.setRelationship(Relationship.PART_OF);
                            } else {
                                extId.setRelationship(Relationship.SELF);
                            }
    ...
    private static void populateExternalIdentifiers(WorkForm workForm, Work work) {
        org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifiers workExternalIds = new org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifiers();
        if(workForm.getWorkExternalIdentifiers() != null && !workForm.getWorkExternalIdentifiers().isEmpty()) {
            for(WorkExternalIdentifier wfExtId : workForm.getWorkExternalIdentifiers()) {
                org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifier wExtId = new org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifier();
                if(!PojoUtil.isEmpty(wfExtId.getWorkExternalIdentifierId())) {
                    wExtId.setWorkExternalIdentifierId(new org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifierId(wfExtId.getWorkExternalIdentifierId().getValue()));
                }
                
                if(!PojoUtil.isEmpty(wfExtId.getWorkExternalIdentifierType())) {
                    wExtId.setWorkExternalIdentifierType(org.orcid.jaxb.model.record_2_rc1.WorkExternalIdentifierType.fromValue(wfExtId.getWorkExternalIdentifierType().getValue()));
                }
    ...
    private static void populateContributors(Work work, WorkForm workForm) {
        ...
        if(work.getWorkContributors() != null) {
            org.orcid.jaxb.model.record_2_rc1.WorkContributors contributors = work.getWorkContributors();
    ...
    private static void populateContributors(WorkForm workForm, Work work) {
        org.orcid.jaxb.model.record_2_rc1.WorkContributors contributors = new org.orcid.jaxb.model.record_2_rc1.WorkContributors();
        if(workForm.getContributors() != null && !workForm.getContributors().isEmpty()) {
            for(Contributor wfContributor : workForm.getContributors()) {
                ...
                if(!PojoUtil.isEmpty(wfContributor.getContributorSequence())) {
                    contributorAttributes.setContributorSequence(org.orcid.jaxb.model.record_2_rc1.SequenceType.fromValue(wfContributor.getContributorSequence().getValue()));
                }                
    ...
    public Work toWork() {
        ...
        if (!PojoUtil.isEmpty(this.getWorkType())) {
            work.setWorkType(org.orcid.jaxb.model.record_2_rc1.WorkType.fromValue(this.getWorkType().getValue()));
        }        
        
        org.orcid.jaxb.model.record_2_rc1.WorkTitle workTitle = new org.orcid.jaxb.model.record_2_rc1.WorkTitle();
        // Set title
        ...
        if(this.getCitation() != null) {
            org.orcid.jaxb.model.record_2_rc1.Citation citation = new org.orcid.jaxb.model.record_2_rc1.Citation();
