...
public class KeywordForm implements ErrorsInterface, Serializable {
    ...
    public Keyword toKeyword() {
        ...
        if (visibility != null && visibility.getVisibility() != null) {
            keyword.setVisibility(org.orcid.jaxb.model.common_rc2.Visibility.fromValue(visibility.getVisibility().value()));
        } else {
            keyword.setVisibility(org.orcid.jaxb.model.common_rc2.Visibility.fromValue(OrcidVisibilityDefaults.KEYWORD_DEFAULT.getVisibility().value()));
        }
