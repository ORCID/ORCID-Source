...
public class Visibility implements ErrorsInterface, Required, Serializable {
    ...
    private org.orcid.jaxb.model.v3.release.common.Visibility visibility;
    
    public Visibility() {
        visibility = org.orcid.jaxb.model.v3.release.common.Visibility.PUBLIC;
    }
    
    public static Visibility valueOf(org.orcid.jaxb.model.message.Visibility visibility) {
        Visibility v = new Visibility();
        v.setVisibility(org.orcid.jaxb.model.v3.release.common.Visibility.valueOf(visibility.name()));
        return v;
    }
    ...
    public static Visibility valueOf(org.orcid.jaxb.model.v3.release.common.Visibility visibility) {
        Visibility v = new Visibility();
        v.setVisibility(org.orcid.jaxb.model.v3.release.common.Visibility.fromValue(visibility.value()));
        return v;
    }
    ...
    public org.orcid.jaxb.model.v3.release.common.Visibility getVisibility() {
        return visibility;
    }

    public void setVisibility(org.orcid.jaxb.model.v3.release.common.Visibility visibility) {
