...
public class FundingExternalIdentifier implements Serializable {
    ...
    public org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifier toRecordPojo() {
        org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifier recordPojo = new org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifier();

        if (this.getType() != null) {
            org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifierType type = org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifierType.fromValue(this.getType().value());
    ...
    public static FundingExternalIdentifier fromRecordPojo(org.orcid.jaxb.model.record_2_rc1.FundingExternalIdentifier recordPojo) {
        FundingExternalIdentifier result = new FundingExternalIdentifier();
