...
public class IssnClientTest {
    ...
    public void setUp() throws IOException {
        ...
        doReturn("anything").when(mockUrlBuilder).buildIssnPortalUrlForIssn(anyString());
    ...
    @Test
    public void testGetIssnDataUseKeyTitle() throws Exception {
        // Correctly mocks the 3-argument doGet call
        doReturn(mockResponse).when(mockHttpRequestUtils).doGet(anyString(), anyString(), any(HttpClient.Redirect.class));
    ...
    @Test
    public void testGetIssnDataUseMainTitle() throws Exception {
        doReturn(mockResponse).when(mockHttpRequestUtils).doGet(anyString(), anyString(), any(HttpClient.Redirect.class));
    ...
    @Test
    public void testGetIssnDataUseNameArray() throws Exception {
        doReturn(mockResponse).when(mockHttpRequestUtils).doGet(anyString(), anyString(), any(HttpClient.Redirect.class));
    ...
    @Test
    public void testGetIssnDataUseNameArrayAsString() throws Exception {
        doReturn(mockResponse).when(mockHttpRequestUtils).doGet(anyString(), anyString(), any(HttpClient.Redirect.class));
    ...
    @Test
    public void testGetIssnDataNoTitle() throws Exception {
        doReturn(mockResponse).when(mockHttpRequestUtils).doGet(anyString(), anyString(), any(HttpClient.Redirect.class));
    ...
    @Test
    public void testGetIssnDataBadCharactersKeyTitle() throws Exception {
        doReturn(mockResponse).when(mockHttpRequestUtils).doGet(anyString(), anyString(), any(HttpClient.Redirect.class));
    ...
    @Test
    public void testGetIssnDataBadCharactersMainTitle() throws Exception {
        doReturn(mockResponse).when(mockHttpRequestUtils).doGet(anyString(), anyString(), any(HttpClient.Redirect.class));
    ...
    @Test
    public void testGetIssnDataBadCharactersNameArray() throws Exception {
        doReturn(mockResponse).when(mockHttpRequestUtils).doGet(anyString(), anyString(), any(HttpClient.Redirect.class));
