...
public class AnalyticsProcessTest {
    ...
    @Test
    public void testAnalyticsProcess() throws InterruptedException {
        ...
        process.setClientDetailsId("some-client-details-id");
        process.setClientDetailsString("name - some-client-details-id");
        ...
        assertEquals("v2.0", data.getApiVersion());
        assertEquals("name - some-client-details-id", data.getClientDetailsString());
