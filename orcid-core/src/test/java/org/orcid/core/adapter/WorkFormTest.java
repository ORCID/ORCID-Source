...
public class WorkFormTest {
    ...
    private Work getWork() {
        ...
        work.setSource(new org.orcid.jaxb.model.v3.rc2.common.Source("0000-0000-0000-0000"));
        work.setUrl(new Url("http://myurl.com"));
        work.setVisibility(org.orcid.jaxb.model.v3.rc2.common.Visibility.PUBLIC);
        ...
        title.setTranslatedTitle(new org.orcid.jaxb.model.v3.rc2.common.TranslatedTitle("Translated Title", "es"));
    ...
    private WorkForm getWorkForm() {
        ...
        form.setVisibility(Visibility.valueOf(org.orcid.jaxb.model.v3.rc2.common.Visibility.PUBLIC));        
