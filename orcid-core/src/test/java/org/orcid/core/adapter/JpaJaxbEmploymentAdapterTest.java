...
public class JpaJaxbEmploymentAdapterTest extends MockSourceBase {
    ...
    public void fromOrgAffiliationRelationEntityToEmployment() {
        ...
        assertEquals(org.orcid.jaxb.model.common_rc2.Iso3166Country.US, employment.getOrganization().getAddress().getCountry());
