 ...
 * =============================================================================
 */
package org.orcid.core.adapter.v2.rc3;
...
public class JpaJaxbEmploymentAdapterTest extends MockSourceNameCache {
    ...
    public void fromOrgAffiliationRelationEntityToEmployment() {
        ...
        assertEquals(org.orcid.jaxb.model.common_rc3.Iso3166Country.US, employment.getOrganization().getAddress().getCountry());
    ...
    private Employment getEmployment(boolean full) throws JAXBException {
        ...
        String name = "/record_2.0_rc3/samples/employment-2.0_rc3.xml";
        if(full) {
            name = "/record_2.0_rc3/samples/employment-full-2.0_rc3.xml";
        }            
