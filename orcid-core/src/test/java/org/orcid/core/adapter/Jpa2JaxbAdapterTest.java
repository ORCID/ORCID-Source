...
public class Jpa2JaxbAdapterTest extends DBUnitTest {
    ...
    public void testProfileEntityToOrcidMessage() {
        ...
        name.setVisibility(org.orcid.jaxb.model.common_rc2.Visibility.PUBLIC);
        profile.setRecordNameEntity(name);

        // Set biography
        BiographyEntity bio = new BiographyEntity();
        bio.setBiography("This is my biography");
        bio.setVisibility(org.orcid.jaxb.model.common_rc2.Visibility.PUBLIC);
        ...
        otherName.setVisibility(org.orcid.jaxb.model.common_rc2.Visibility.PUBLIC);
        ...
        address.setVisibility(org.orcid.jaxb.model.common_rc2.Visibility.PUBLIC);
        ...
        rUrl.setVisibility(org.orcid.jaxb.model.common_rc2.Visibility.PUBLIC);
        ...
        extId.setVisibility(org.orcid.jaxb.model.common_rc2.Visibility.PUBLIC);
