...
public class V3VersionConverterChainTest {
    ...
    public void upgradeRC1ToRC2Test() {
        ...
        rc1WorkSummary.setPublicationDate(new org.orcid.jaxb.model.v3.rc1.common.PublicationDate(new org.orcid.jaxb.model.v3.rc1.common.Year(2018), new org.orcid.jaxb.model.v3.rc1.common.Month(1), new org.orcid.jaxb.model.v3.rc1.common.Day(1)));
    ...
    public void downgradeRC2ToRC1Test() {
        ...
        rc2Work.setPublicationDate(new org.orcid.jaxb.model.v3.rc2.common.PublicationDate(new org.orcid.jaxb.model.v3.rc2.common.Year(2018), new org.orcid.jaxb.model.v3.rc2.common.Month(1), new org.orcid.jaxb.model.v3.rc2.common.Day(1)));
        ...
        rc2Work.setWorkCitation(new org.orcid.jaxb.model.v3.rc2.record.Citation("This is the citation", org.orcid.jaxb.model.v3.rc2.record.CitationType.FORMATTED_UNSPECIFIED));
        ...
        extId.setRelationship(org.orcid.jaxb.model.v3.rc2.record.Relationship.SELF);
        extId.setType("type");
        ...
        assertEquals(org.orcid.jaxb.model.v3.rc1.common.ContributorRole.ASSIGNEE, rc1Work.getWorkContributors().getContributor().get(0).getContributorAttributes().getContributorRole());
        assertEquals(org.orcid.jaxb.model.v3.rc1.record.SequenceType.ADDITIONAL, rc1Work.getWorkContributors().getContributor().get(0).getContributorAttributes().getContributorSequence());
        ...
        rc2WorkSummary.setPublicationDate(new org.orcid.jaxb.model.v3.rc2.common.PublicationDate(new org.orcid.jaxb.model.v3.rc2.common.Year(2018), new org.orcid.jaxb.model.v3.rc2.common.Month(1), new org.orcid.jaxb.model.v3.rc2.common.Day(1)));
