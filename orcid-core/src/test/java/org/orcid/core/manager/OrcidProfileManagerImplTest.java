...
//        assertEquals(1, profile1.getOrcidBio().getApplications().getApplicationSummary().size());
    ...
    public void testAddOrcidWorks() {
        ...
        assertEquals("Another Title", works.get(2).getWorkTitle().getTitle().getContent());
        assertEquals("Journal of Cloud Spotting", works.get(2).getWorkTitle().getSubtitle().getContent());
    ...
    public void testPrimaryAddressDontChangeOnClaimedRecords() {
        ...
        assertEquals(org.orcid.jaxb.model.common_rc3.Iso3166Country.US, profileEntity.getAddresses().iterator().next().getIso2Country());
        ...
        while(it.hasNext()) {
            assertThat(it.next().getIso2Country(), anyOf(is(org.orcid.jaxb.model.common_rc3.Iso3166Country.US), is(org.orcid.jaxb.model.common_rc3.Iso3166Country.CR)));
        }        
        ...
        while(it.hasNext()) {
            assertThat(it.next().getIso2Country(), anyOf(is(org.orcid.jaxb.model.common_rc3.Iso3166Country.US), is(org.orcid.jaxb.model.common_rc3.Iso3166Country.CR), is(org.orcid.jaxb.model.common_rc3.Iso3166Country.PE)));
        }  
