...
public class ValidateV2RC2SamplesTest {
    ...
    public void testUnmarshallWorkBulk() {
        ...
        assertEquals("doi", w2.getExternalIdentifiers().getExternalIdentifier().get(0).getWorkExternalIdentifierType().value());
        assertEquals("10.1016/j.crvasa.2015.05.007", w2.getExternalIdentifiers().getExternalIdentifier().get(0).getWorkExternalIdentifierId().getContent());        
        ...
        assertEquals("doi", w3.getExternalIdentifiers().getExternalIdentifier().get(0).getWorkExternalIdentifierType().value());
        assertEquals("10.1016/j.crvasa.2015.05.008", w3.getExternalIdentifiers().getExternalIdentifier().get(0).getWorkExternalIdentifierId().getContent()); 
    }
