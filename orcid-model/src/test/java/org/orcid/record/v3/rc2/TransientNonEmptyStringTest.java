...
public class TransientNonEmptyStringTest {
    ...
    public void testMarshal() throws JAXBException, SAXException, IOException{
        ...
        Schema schema = factory.newSchema(getClass().getResource("/common_3.0_rc2/common-3.0_rc2.xsd"));
    ...
    public void testUnmarshal(){
        ExternalIDs ids = unmarshallFromPath("/common_3.0_rc2/samples/common-3.0_rc2_external-identifier.xml", ExternalIDs.class); 
