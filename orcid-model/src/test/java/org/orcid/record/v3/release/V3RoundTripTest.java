...
public class V3RoundTripTest {
     ...
     */
    @Test
    public void testReadXmlThenWriteThenReadV3_0() throws JAXBException, IOException {
        OrcidTranslator<org.orcid.jaxb.model.v3.release.record.Record> t = OrcidTranslator.v3_0();
        Reader reader = new InputStreamReader(getClass().getResourceAsStream("/record_3.0/samples/read_samples/record-3.0.xml"));
        
        //read the xml
        org.orcid.jaxb.model.v3.release.record.Record r = t.readXmlRecord(reader);
        ...
        org.orcid.jaxb.model.v3.release.record.Record r2 = t.readXmlRecord(reader2);
