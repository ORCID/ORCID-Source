...
public class V3RoundTripTest {
     ...
     */
    @Test
    public void testReadXmlThenWriteThenReadV3_0rc2() throws JAXBException, IOException {
        OrcidTranslator<org.orcid.jaxb.model.v3.rc2.record.Record> t = OrcidTranslator.v3_0RC2();
        Reader reader = new InputStreamReader(getClass().getResourceAsStream("/record_3.0_rc2/samples/read_samples/record-3.0_rc2.xml"));
        
        //read the xml
        org.orcid.jaxb.model.v3.rc2.record.Record r = t.readXmlRecord(reader);
        ...
        org.orcid.jaxb.model.v3.rc2.record.Record r2 = t.readXmlRecord(reader2);
