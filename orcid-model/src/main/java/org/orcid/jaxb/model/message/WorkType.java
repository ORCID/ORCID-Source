...
public enum WorkType implements Serializable {
    ...
    CHAPTER_ANTHOLOGY("chapter-anthology"), @XmlEnumValue("conference-proceedings")
    CONFERENCE_PROCEEDINGS("conference-proceedings"), @XmlEnumValue("congressional-publication")
    CONGRESSIONAL_PUBLICATION("congressional-publication"), @XmlEnumValue("database")
    ...
    NEWSPAPER_ARTICLE("newspaper-article"), @XmlEnumValue("other")
    OTHER("other"), @XmlEnumValue("pamphlet")
    PAMPHLET("pamphlet"), @XmlEnumValue("patent")
