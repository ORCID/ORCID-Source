...
#ORCID API v3.0_rc1 Peer Review Guide
Starting in v3.0_rc1, the ORCID API now supports a new activity type: ```peer-review```. 
...
##Peer Review XML
XML for the ```peer-review``` activity follows the [peer-review-3.0_rc1.xsd](https://github.com/ORCID/ORCID-Source/blob/master/orcid-model/src/main/resources/record_3.0_rc1/peer-review-3.0_rc1.xsd) and consists of the following sections:
...
For an example XML file, see [peer-review-3.0_rc1.xml](https://github.com/ORCID/ORCID-Source/blob/master/orcid-model/src/main/resources/record_3.0_rc1/samples/peer-review-3.0_rc1.xml )
...
|-------------------------|-------------|--------------------------|----------------------------------------------------------|
| Read activities summary | GET         | /read-limited | https://api.sandbox.orcid.org/v3.0_rc1/[ORCID-iD]/activities |

###Read/Modifiy Peer Review Activities
| Action             | HTTP method | Scope                    | URL                                                                      |
|--------------------|-------------|--------------------------|--------------------------------------------------------------------------|
| Add peer-review item    | POST        | /activities/update       | https://api.sandbox.orcid.org/v3.0_rc1/[ORCID-iD]/peer-review            |
| Read peer-review item   | GET         | /read-limited | https://api.sandbox.orcid.org/v3.0_rc1/[ORCID-iD]/peer-review/[PUT-CODE] |
| Update peer-review item | PUT         | /activities/update       | https://api.sandbox.orcid.org/v3.0_rc1/[ORCID-iD]/peer-review/[PUT-CODE] |
| Delete peer-review item | DELETE      | /activities/update       | https://api.sandbox.orcid.org/v3.0_rc1/[ORCID-iD]/peer-review/[PUT-CODE] |
...
curl -i -H "Accept: application/orcid+xml" \
	...
	'https://api.sandbox.orcid.org/v3.0_rc1/0000-0002-1306-4180/activities'
```
...
curl -i -H 'Content-type: application/orcid+xml’ \
	...
	-X POST 'https://api.sandbox.orcid.org/v3.0_rc1/[ORCID]/peer-review'
```
...
curl -i -H "Accept: application/orcid+xml" \
	-H 'Authorization: Bearer dd91868d-d29a-475e-9acb-bd3fdf2f43f4' \
	'https://api.sandbox.orcid.org/v3.0_rc1/[ORCID]/peer-review/[PUT-CODE]'
```
...
curl -i -H 'Content-type: application/orcid+xml’ \
	...
	-X PUT 'https://api.sandbox.orcid.org/v3.0_rc1/[ORCID]/peer-review/[PUT-CODE]'
```
...
curl -i -H 'Content-type: application/orcid+xml’ \
	-H 'Authorization: Bearer dd91868d-d29a-475e-9acb-bd3fdf2f43f4' \
	-X DELETE 'https://api.sandbox.orcid.org/v3.0_rc1/[ORCID]/peer-review/[PUT-CODE]'
```
