...
For an example XML file, see [notification-permission-3.0_rc1.xml](https://github.com/ORCID/ORCID-Source/blob/master/orcid-model/src/main/resources/notification_3.0_rc1/samples/notification-permission-3.0_rc1.xml)
