...
#ORCID API v2.0_rc3 Peer Review Guide
Starting in v2.0_rc3, the ORCID API now supports a new activity type: ```peer-review```. 
...
##Peer Review XML
XML for the ```peer-review``` activity follows the [peer-review-2.0_rc3.xsd](https://github.com/ORCID/ORCID-Source/blob/master/orcid-model/src/main/resources/record_2.0_rc3/peer-review-2.0_rc3.xsd) and consists of the following sections:
...
For an example XML file, see [peer-review-2.0_rc3.xml](https://github.com/ORCID/ORCID-Source/blob/master/orcid-model/src/main/resources/record_2.0_rc3/samples/peer-review-2.0_rc3.xml )
