...
| ------------ | ------------ | ----------- | ----- | -------------------------------- |
| [ORCID XSD 1.0.x](https://github.com/ORCID/ORCID-Source/tree/master/orcid-model/src/main/resources) | various | Mar 1, 2014 | **SUNSET VERSIONS** <br><br> Versions 1.0.1 - 1.0.23 | These versions were sunset as of March 1, 2014. They are no longer supported, and should not be used. |
