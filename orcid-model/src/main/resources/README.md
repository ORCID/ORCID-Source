...
* **[ORCID Message 1.2](https://github.com/ORCID/ORCID-Source/blob/master/orcid-model/src/main/resources/orcid-message-1.2.xsd)** - [DOCUMENTATION](http://orcid.github.io/XSD/XSD_1.2_Documentation/orcid-message-1.2.html)<br/>_Read the [change log from the previous version (ORCID Message 1.1)](http://support.orcid.org/knowledgebase/articles/481386-xsd-1-2-update)_
