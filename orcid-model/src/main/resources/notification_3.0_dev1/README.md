...
#ORCID API v3.0_dev1 Notifications Permission Guide
Starting in v3.0_dev1, the ORCID API supports new functionality to enable member organizations to add permission requests to a user's ORCID Inbox. These requests provide a "snapshot" example of the type of activities that will be added to the user's ORCID record as a result of granting the permission.
...
XML for the ```permission``` notifications follows the [notification-permission-3.0_dev1.xsd](https://github.com/ORCID/ORCID-Source/blob/master/orcid-model/src/main/resources/notification_3.0_dev1/notification-permission-3.0_dev1.xsd) and consists of the following sections:
...
For an example XML file, see [notification-permission-3.0_dev1.xml](https://github.com/ORCID/ORCID-Source/blob/master/orcid-model/src/main/resources/notification_3.0_dev1/samples/notification-permission-3.0_dev1.xml)
...
|-------------------------|-------------|--------------------------|----------------------------------------------------------|
| Add a notification | POST | /premium-notification | http://api.sandbox.orcid.org/v3.0_dev1/[ORCID]/notification-permission |
| Read a notification | GET | /premium-notification | http://api.sandbox.orcid.org/v3.0_dev1/[ORCID]/notification-permission/[PUT-CODE] |
| Flag an unread notification as archived | DELETE | /premium-notification | http://api.sandbox.orcid.org/v3.0_dev1/[ORCID]/notification-permission/[PUT-CODE] |
...
curl -i -H 'Authorization: Bearer ...' \
	...
	https://api.sandbox.orcid.org/v3.0_dev1/[ORCID]/notification-permission
```
...
curl -i -H 'Authorization: Bearer ...' \
	-H 'Content-Type: application/orcid+xml' \
	https://api.sandbox.orcid.org/v3.0_dev1/[ORCID]/notification-permission/[PUT-CODE]
```
...
curl -i -H 'Authorization: Bearer ...' \
	-H 'Content-Type: application/orcid+xml' \
	-X DELETE https://api.sandbox.orcid.org/v3.0_dev1/[ORCID]/notification-permission/[PUT-CODE] 
```